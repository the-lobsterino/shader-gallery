...
{	
	...
	letters = min(letters,M(p.xy-vec2( 0.50,0.9)));
	letters = min(letters,P(p.xy-vec2( 1.00,0.9)));
	letters = min(letters,I(p.xy-vec2( -1.,.2)));
	letters = min(letters,S(p.xy-vec2( -.5,.2)));
	letters = min(letters,G(p.xy-vec2( 0.,.2)));
	letters = min(letters,E(p.xy-vec2( .5,.2)));
	letters = min(letters,Y(p.xy-vec2( 1.,.2)));
