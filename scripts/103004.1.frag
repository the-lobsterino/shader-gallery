/*R050430作例　綱渡り　by ニシタマオ　THE SEA PANTHER*/
/*サンドボックス上での試験用、簡易レイトレシステム、反射・屈折、ぼかし影、カラーパレット機能付（R050430版）*/
...
vec4 VP_DefaultCamera =vec4(0, 4,-8, 0);
...
float fNLetters00(vec4 VP){
	float NP =1e+6;
		{ float nE =float(1);  vec3 V3C =vec3(2.5,2.5,1) *nE,  V3D =vec3(5,0,0) *nE, V3P;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-1.5,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-1.5,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0) *nE; VB.xy =vec2(-1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0) *nE; VB.xy =vec2(-1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0) *nE; VB.xy =vec2(-1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-1) *nE; VB.xy =vec2(-2,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1) *nE; VB.xy =vec2(-1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-2) *nE; VB.xy =vec2(0,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1.5) *nE; VB.xy =vec2(1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(1.5,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(1.5,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0.5) *nE; VB.xy =vec2(1.5,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5) *nE; VB.xy =vec2(0.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1.5) *nE; VB.xy =vec2(1.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-1.5) *nE; VB.xy =vec2(1.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1.5) *nE; VB.xy =vec2(1.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-1.5) *nE; VB.xy =vec2(1.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-1.5) *nE; VB.xy =vec2(1.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-1,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2) *nE; VB.xy =vec2(1,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5) *nE; VB.xy =vec2(0,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1.5) *nE; VB.xy =vec2(-0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1.5) *nE; VB.xy =vec2(-0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0.5) *nE; VB.xy =vec2(2,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1) *nE; VB.xy =vec2(0.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0) *nE; VB.xy =vec2(1.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0) *nE; VB.xy =vec2(1.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5) *nE; VB.xy =vec2(1.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-2,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(1,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;}
...
/*熊体形状生成機能、中割機能付（R050430版）by ニシタマオ*/
//	主要関数（R050430版）
...
sskelton fSSRSet_TightRope01P(sskelton SS){
	float nD =acos(-1.0) /180.0, nS =sin(SS.VP.w *20.0), nC =sin(SS.VP.w *15.0);

	SS.VR_Body =vec4(0,	+15.0 *nS,	30,	0);
	SS.VR_Shld =vec4(0,	0, 	15,	1);
	SS.VR_Neck =vec4(0,	0,	60,	0);
	SS.VR_Head =vec4(0,	0,	0,	1);
	SS.VR_ArRU =vec4(180,	15.0 *nC,	15.0 *nS,	0);
	SS.VR_ArLU =vec4(0,	0,	0,	0);
	SS.VR_ArRL =vec4(0,	0,	0,	1);
	SS.VR_ArLL =vec4(0,	0,	0,	1);
	SS.VR_LeRU =vec4(+15.0 *nS,	0,	0,	0);
	SS.VR_LeLU =vec4(-15.0 *nS,	0,	0,	0);
	SS.VR_LeRL =vec4(+15.0 *nS -15.0,	0,	0,	1);
	SS.VR_LeLL =vec4(-15.0 *nS -15.0,	0,	0,	1);
	SS.VR_HndR =vec4(0,	0,	0,	1);
	SS.VR_HndL =vec4(0,	0,	0,	1);
	SS.VR_FotR =vec4(-45,	0,	0,	1);
	SS.VR_FotL =vec4(-45,	0,	0,	1);

	SS =fSSRChange_Multiple(SS, nD);
	return SS;
}

sskelton fSSRSet_TightRope01N(sskelton SS){
	float nD =acos(-1.0) /180.0, nS =sin(SS.VP.w);
	SS.VR_Body =vec4(0,	-60,	-30,	0);
	SS.VR_Shld =vec4(0,	-30, 	0,	1);
	SS.VR_Neck =vec4(0,	0,	0,	0);
	SS.VR_Head =vec4(0,	0,	0,	1);
	SS.VR_ArRU =vec4(180,	0,	0,	0);
	SS.VR_ArLU =vec4(90,	0,	0,	0);
	SS.VR_ArRL =vec4(0,	0,	0,	1);
	SS.VR_ArLL =vec4(90,	0,	0,	1);
...
float fNOutfit_Dilbert01(sskelton SS){
	...
	if(true){
		...
		V3Pi =V3P;
		float nPi;
		nPi =max(abs(V3Pi.x) -0.2 *nE, abs(V3Pi.z) -0.05 *nE);
		nPi =max(nPi, V3Pi.y -0.25);
		if(V3P.y >0.0)	NP =min(NP, nPi);	

		V3Pi =V3P;
		V3Pi.z +=0.8 *nE;
		nPi =max(abs(V3Pi.x) -0.2 *nE, abs(V3Pi.z) -0.05 *nE);
		nPi =max(nPi, max(+V3Pi.x +V3Pi.y -0.5 *nE,-V3Pi.x +V3Pi.y -0.5 *nE));
		if(V3P.y >0.0)	NP =min(NP, nPi);	

		V3Pi =V3P;
		V3Pi.z +=0.4 *nE;
		vec2 V2Pi =vec2(length(V3Pi.yz) -0.4 *nE, V3Pi.x);
		nPi =max(abs(V2Pi.x) -0.05 *nE, abs(V2Pi.y) -0.2 *nE);
		if(V3P.y <0.0)	NP =min(NP, nPi);	
...
float fNObject_TightRopeDilbert01(vec4 VP){//綱渡り
	VP.w *=0.25;
	int iRL =int(mod(VP.w *2.0, 4.0));

	sskelton SS,SSP,SSN;
	SS.VP =VP;
	SS =SSP =SSN =fSSPSet_Man01( SS);
	SSP =fSSRSet_TightRope01P( SS);
	SSN =fSSRSet_TightRope01N( SS);



	if(iRL ==1 || iRL ==2 || iRL ==5 || iRL ==6){
		SSP =fSSChange_MirrorX(SSP);
	}
	if(iRL ==2 || iRL ==3 || iRL ==6 || iRL ==7){
		SSN =fSSChange_MirrorX(SSN);
	}

	SS =fSSChange_Inbetween(SSP, SSN, cos(VP.w *acos(-1.0) *2.0));
	SS =fSSkeltonMake( SS);

	vec3 V3P_Hold;
	if(iRL ==0 || iRL ==3 || iRL ==4 || iRL ==7){
		V3P_Hold =SS.VP_HndR.xyz;
	}else{
		V3P_Hold =SS.VP_HndL.xyz;
	}
...
float fNMap(vec3 V3P){
	...
	if(true){	//綱渡り
		...
		vec4 VPi =VP;
		VPi.z +=floor((VPi.w -2.0) *0.25) *3.25;
		vec2 V2P_Mod =mod(VPi.xz, 16.0) -8.0, V2P_Dom =VPi.xz -V2P_Mod;
		float nRandom =fNRandom(V2P_Dom.x);
		VPi.y +=sin(VP.z *0.1 +nRandom *10.0) *4.0;
		VPi.xz =V2P_Mod;
		...
		nPi =fNObject_TightRopeDilbert01(VPi);
...
sface fSFEffect_Before(sface SF, smarch SM){
	...
	if(SF.ID_Pallet ==51){
		VColor.rgb =sign(sin(VP.z *2.0)) *vec3(1,1,0) *0.5 +vec3(1,1,0) *0.5;
	}
