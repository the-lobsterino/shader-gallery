...
//omg i got her from e#666 LOL XDDDDDDDDDDDDDDDDDDD AAHAHHAHHA AYY LMAO MAYMAYZ 4 CHRISTIANS
...
void main( void ) {
	...
	vec2 d = vec2(facetsX - facets, facetsY - facets);
	float light = pow(clamp(1.-length(uv - mouse + d),0.,1.),3.0) * 1.25 + 0.2;
