...
void main(void)
{
	...
	d += C(r()); add(); d += A(r()); add(); d += N(r()); add(); space(); add(); d += S(r()); add(); d += O(r()); add(); d += M(r()); add(); d += O(r()); add(); d += N(r()); add(); d += E(r()); space();
	newline();
	d += D(r()); add(); d += O(r()); add(); space(); add(); d += M(r()); add(); d += A(r()); add(); d += R(r()); add(); d += B(r()); add(); d += L(r()); add(); d += E(r());
	newline();
	d += L(r()); add(); d += O(r()); add(); d += L(r()); add(); space(); add(); d += N(r()); add(); d += O(r());
