...
#define MaterialIndex4              4
#define MaterialIndex5              5
#define MaterialIndex6              6
#define MaterialIndex7              7
#define MaterialIndex8              8
#define MaterialIndex9              9
#define MaterialIndex10             10
//--------------------------------------------------------------------------------------------
// End Region
//--------------------------------------------------------------------------------------------
...
Material getMaterial( int materialIndex )
{
    ...
    if( materialIndex == MaterialIndex3 ) return materials[3];
    if( materialIndex == MaterialIndex4 ) return materials[4];
    if( materialIndex == MaterialIndex5 ) return materials[5];
    if( materialIndex == MaterialIndex6 ) return materials[6];
    if( materialIndex == MaterialIndex7 ) return materials[7];
    if( materialIndex == MaterialIndex8 ) return materials[8];
    if( materialIndex == MaterialIndex9 ) return materials[9];
...
void initializeMaterials()
{
    ...
    materials[1].diffuseColor = vec3( 1.0, 1.4, 1.0 );
    ...
    materials[2].diffuseColor = vec3( 1.0, 0.4, 1.0 );
    materials[2].specularColor = vec3( 1.0 );
    materials[2].specularIntensity = 20.0;
    materials[2].shadowCasterIntensity = 0.5;
    materials[2].reflectionIntensity = 0.7;
    materials[2].refractionIndex = 1.0;
    materials[2].refractionIntensity = 0.00;

    materials[3].diffuseColor = vec3( 0.0, 1.0, 1.4 );
    materials[3].specularColor = vec3( 1.0 );
    materials[3].specularIntensity = 10.0;
    materials[3].shadowCasterIntensity = 0.5;
    materials[3].reflectionIntensity = 0.00;
    materials[3].refractionIndex = 1.0;
    materials[3].refractionIntensity = 0.00;

    materials[4].diffuseColor = vec3( 0.8 );
    materials[4].specularColor = vec3( 1.0 );
    materials[4].specularIntensity = 10.0;
    materials[4].shadowCasterIntensity = 1.0;
    materials[4].reflectionIntensity = 0.00;
    materials[4].refractionIndex = 1.0;
    materials[4].refractionIntensity = 0.00;

    materials[5].diffuseColor = vec3( 1.0, 0.0, 0.0 );
    materials[5].specularColor = vec3( 1.0 );
    materials[5].specularIntensity = 10.0;
    materials[5].shadowCasterIntensity = 1.0;
    materials[5].reflectionIntensity = 0.00;
    materials[5].refractionIndex = 1.0;
    materials[5].refractionIntensity = 0.00;
}
...
void onAnimateScene()
{
    ...
    spheres[2].position.y += abs( sin( animationTime * 4.0 ) * 2.0 );
    spheres[2].position.z += sin( cos( animationTime)  *    3.0 ) * 2.0;

    spheres[4].position.x -= sin( animationTime * 1.0 ) * 3.0;
    spheres[4].position.y += abs( sin( animationTime * 5.3 ) * 2.0 );
    spheres[4].position.z -= sin( cos( animationTime)  *    3.0 ) * 2.0;
}
...
vec3 getObjectsBaseColor(HitInfo hitInfo)
{
    ...
    if( hitInfo.id == 5 || hitInfo.id == 9 )
    {
       
        return checkerBoardTexture( hitInfo.position ) * mat.diffuseColor;
    }
...
//--------------------------------------------------------------------------------------------
float calculateShadow( vec3 lightDir, HitInfo hitInfo )
{
    Ray shadowRay;
    ...
    Material mat = getMaterial(shadowHitInfo.materialIndex);
    return clamp( mat.shadowCasterIntensity, 0.00, 1.0 );
}
...
void main(void)
{
    ...
    float shadowFactor = calculateShadow( lightDir, hitInfo );
    ...
    c = (diffuse + specular) * shadowFactor;
