...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	//d += T(r()); d += H(r()); d += E(r()); _();
	d += F(r()); d += B(r()); d += W(r()); d += A(r()); d += R(r()); d += E(r()); _();
	d += C(r()); d += L(r()); d += I(r()); d += E(r()); d += N(r()); d += T(r()); _();
	newline();

	d += S(r()); d += T(r()); d += A(r()); d += Y(r()); d += S(r()); _();
	d += O(r()); d += N(r()); _();
	d += T(r()); d += O(r()); d += P(r()); _();
	newline();

	d += F(r()); d += O(r()); d += R(r()); d += E(r()); d += V(r()); d += E(r());d += R(r()); _();
	d += L(r()); d += A(r()); d += D(r()); d += S(r()); d += STOP(r()); d += STOP(r()); d += STOP(r());
