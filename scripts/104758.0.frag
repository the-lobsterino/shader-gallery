...
vec3 borderColor = vec3(32. / 255., 35. / 255., 32. / 255.);
vec3 hairColor0 = vec3(151. / 255., 200. / 255., 234. / 255.);
vec3 hairColor1 = vec3(77. / 255., 135. / 255., 192. / 255.);
vec3 hairColor2 = vec3(58. / 255., 103. / 255., 151. / 255.);
vec3 faceColor0 = vec3(247. / 255., 223. / 255., 204. / 255.);
vec3 faceColor1 = vec3(209. / 255., 173. / 255., 159. / 255.);
vec3 faceColor2 = vec3(183. / 255., 148. / 255., 133. / 255.);
vec3 eyeColor0 = vec3(145. / 255., 164. / 255., 176. / 255.);
vec3 eyeColor1 = vec3(207. / 255., 216. / 255., 218. / 255.);
vec3 eyeColor2 = vec3(255. / 255., 255. / 255., 255. / 255.);
vec3 eyeColor3 = vec3(0, 0, 0);
vec3 eyeColor4 = hairColor0;
vec3 eyeColor5 = hairColor2;
vec3 eyeColor6 = hairColor1;
vec3 mouthColor0 = vec3(78. / 255., 53. / 255., 40. / 255.);
vec3 mouthColor1 = vec3(152. / 255., 78. / 255., 69. / 255.);
vec3 mouthColor2 = vec3(170. / 255., 92. / 255., 83. / 255.);
vec3 backgroundColor = vec3(51. / 255., 124. / 255., 221. / 255.);
