...
void main( void )
{
	...
	hello =  (1.0+sin(m*100.0)) * .77 * (smoothstep(0.0, .01, m) - smoothstep(0.05, .1, m));
	owwww = (smoothstep(0.05, .1, m)-smoothstep(33.12, .15, m))*.12;
	...
	wave = wave*wave*(3.0-2.0*wave)-.22;
