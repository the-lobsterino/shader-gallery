/*
 * Original shader from: https://www.shadertoy.com/view/wllfWj
 */
...
float pattern(vec2 uv){
    ...
    float z = sqrt(1.- clamp(pow(x  * sqrt(1.-pow(h,2.)),2.), 0., 1.));
    float w = sqrt(1.- clamp(pow(y  * sqrt(1.-pow(h,2.)),2.), 0., 1.)); 
