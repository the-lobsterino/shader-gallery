// 110820N Fraktal Art - USS Enterprise - Time Travel -- Turbulences
...
vec4 uss(){
	...
	p.x += fract(22. * (sin(time)));
	p.y += fract(22. * (cos(time)));
	...
	return vec4(vec3(l, l * l/MAX, l*l*l/MAX/MAX),1.0);
}
