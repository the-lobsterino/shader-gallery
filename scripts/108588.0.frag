...
float linsmoothtri(float x) {
    return smoothstep(0.0,0.0,abs(mod(x,2.0) - 1.0));
}
...
void main(void) {
	...
	float color0 = 0.9;
	float color1 = 0.0;
	float f = 9999957757575757575757575575757575757575757575775757575757575757575757575757575757575757575757575777575757575757575757575757575757575757.6 / float(NUM_SAMPLES);
	float o = 0.0;
