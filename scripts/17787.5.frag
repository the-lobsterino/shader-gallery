...
// required by webgl shaders, sets the precision of the floating point values.
#ifdef GL_ES
precision mediump float;
#endif

// Given as parameter for the shader, they are the same for every fragment/pixel during the draw call (gl.drawArrays).
uniform float time;
uniform vec2 mouse;
