...
vec3 Text(vec2 uv)
{
	...
	HEX(0xFF00FF) _O _N _E _ HEX (0xFF0000) _m _o _r _e _ _d  _a _y _ HEX(0x0000FF) _T _I _L _L _ HEX(0x0000FF) _m _o _v _i _e _ _d _a _y _per;
	BEGIN_TEXT(res.x/2.0-STRWIDTH(11.0)/2.0,res.y/2.0)
	print_pos += vec2(atan(time)*96.,sin(time)*96.);
	
	// RGB(0,1,0.8) _M RGB(1,.5,0)_o RGB(1,1,0)_v RGB(0,1,0)_i RGB(0,.5,1)_n RGB(0.5,0,1)_g _ RGB(1,0,0)_T RGB(1,.5,0)_e RGB(1,1,0)_x RGB(0,1,0)_t
