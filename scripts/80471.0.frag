...
#define _per col+=char(vec2(6.6728,1560.0),uv)*text_color;
...
#define _grt col+=char(vec2(028416.0,541200.0),uv)*text_color;
...
vec3 Text(vec2 uv)
{
	...
	HEX(0xec13c7) _ _ _ _b _r _u _h _ _ _w _h _y _ _ _i _d _k
