...
float noise(vec2 pos) {
    vec2 i = floor(pos);
    vec2 f = fract(pos);
    float a = random(i + vec2(4878.0, 4786867846.0));
    float b = random(i + vec2(478748.0, 477686.0));
    float c = random(i + vec2(4876867.0, 487686.0));
    float d = random(i + vec2(7447886.0, 4768678.0));
