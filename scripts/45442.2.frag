...
vec3 grad(float f){
	...
	vec4 c02=vec4(0.5,0.0,0.0,0.70);
	vec4 c03=vec4(1.0,0.0,0.0,0.80);
	vec4 c04=vec4(1.0,1.0,0.0,0.90);
	vec4 c05=vec4(1.0,1.0,1.0,1.50);
...
void main( void ) {
   ...
   float a=
       makePoint(x,y,3.3,2.9,0.3,0.3,time,cos(time*40.0)*7.0);
   ...
   a=a+makePoint(x,y,0.8,1.7,0.5,0.4,time,sin(time*14.0)*8.0);
   a=a+makePoint(x,y,0.3,1.0,0.4,0.4,time,cos(time*4.0)*15.0);
   ...
   a=a+makePoint(x,y,1.2,1.9,0.3,0.3,time,sin(time*4.0)*5.0);
   a=a+makePoint(x,y,0.7,2.7,0.4,0.4,time,1.0);
   a=a+makePoint(x,y,1.4,0.6,0.4,0.5,time,cos(time*14.0)*8.0);
   a=a+makePoint(x,y,2.6,0.4,0.6,0.3,time,1.0);
   a=a+makePoint(x,y,0.7,1.4,0.5,0.4,time,sin(time*40.0)*3.0);
   a=a+makePoint(x,y,0.7,1.7,0.4,0.4,time,1.0);
   a=a+makePoint(x,y,0.8,0.5,0.4,0.5,time,cos(time*4.0)*8.0);
