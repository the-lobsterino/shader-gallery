...
void main(void)
{
    	...
    	gl_FragColor += mainImage(gl_FragCoord.xy + vec2(100.0*sin(time), 100.0*cos(time)));	
	gl_FragColor += mainImage(gl_FragCoord.xy - vec2(100.0*sin(time), 100.0*cos(time)));	
}