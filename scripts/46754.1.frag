...
#define TIGHTNESS 100.0
#define YOFFSET 0.8
#define YSCALE 0.61
#define FLAMETONE vec3(255.0, 255.0, 255.0)
...
void main( void ) {
	...
	for (int i=1; i<ITERATIONS+1; i++)
	{
		...
		nx += noise( vec2(uv.y*ii-time*ifrac, uv.x*YSCALE*ii-t)) * d * 2.0;
		ny += noise( vec2(uv.y*ii+time*ifrac, uv.x*YSCALE*ii-t)) * d;
	}
