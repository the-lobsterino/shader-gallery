//fog fix for upwards rays 

//Original: https://www.shadertoy.com/view/XlsyWB
//Fixed by FlyedCode then unmangled by Barack OBusiness
...
vec4 castRay(vec3 eye, vec3 ray) {
   ...
   // if (ray.z < 0.0) {
        return vec4(1000., beacon, 0.0, 1.0);
   // }
