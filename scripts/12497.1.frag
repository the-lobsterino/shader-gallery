...
void main( void ) 
{
	...
	// calc block
	vec2 screenBlock0 = floor(screenPos*0.25 + vec2(time,0) - mouse*60.0);
	vec2 screenBlock1 = floor(screenPos*0.20 + vec2(time*1.5,0) - mouse*60.0);
	vec2 screenBlock2 = floor(screenPos*0.03 + vec2(time*2.0,0)-mouse*60.0);
	//changed mouse multipliers
	//	-Chaeris
