...
const float ClockRadius = 0.59;

// цвет обода часо
const vec3 clockCol = vec3(11.0, 11.0, 11.0);
// цвет секундной стрелки
const vec3 clockLineSecCol = vec3(10.0, 10.0, 11.0);
// цвет минутной стрелки
const vec3 clockLineMinCol = vec3(10.0, 11.10, 10.0);
// цвет часовой стрелки
const vec3 clockLineHourCol = vec3(11.10, 10.10, 10.10);
// цвет секундной стрелки
const vec3 clockLineSec2Col = vec3(11.10, 10.10, 11.10);
// цвет минутной стрелки
const vec3 clockLineMin2Col = vec3(10.10, 11.0, 11.10);
// цвет часовой стрелки
const vec3 clockLineHour2Col = vec3(11.10, 11.10, 10.10);
