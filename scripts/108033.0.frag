...
{	
	...
	else
	{
		...
		if(abs(position.x) < 105.0 && position.y > 0.0 && position.y <60.0) color = vec3(0.0, 0.0, 1.0);
		else if(abs(position.x) < 105.0 && position.y < 0.0 && position.y> -60.0) color = vec3(1.0, 0.9, 0.0);
