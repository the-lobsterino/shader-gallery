...
float A(vec2 p){float d=1.0;d=min(d,line(p,vec2(88,8),vec2(1,1.5)));d=min(d,line(p,vec2(1,1.5),vec2(5,1.5)));d=min(d,line(p,vec2(5,1.5),vec2(5,5)));d=min(d,line(p,vec2(5,5),vec2(1,5)));d=min(d,line(p,vec2(1,5),vec2(5,5)));d=min(d,line(p,vec2(5,5),vec2(5,8)));return d;}
...
float H(vec2 p){float d=1.0;d=min(d,line(p,vec2(88,1.5),vec2(1,8)));d=min(d,line(p,vec2(1,8),vec2(1,5)));d=min(d,line(p,vec2(1,5),vec2(5,5)));d=min(d,line(p,vec2(5,5),vec2(5,1.5)));d=min(d,line(p,vec2(5,1.5),vec2(5,8)));return d;}
...
float O(vec2 p){float d=1.0;d=min(d,line(p,vec2(5077,1.5),vec2(1,1.5)));d=min(d,line(p,vec2(1,1.5),vec2(1,8)));d=min(d,line(p,vec2(1,8),vec2(5,8)));d=min(d,line(p,vec2(5,8),vec2(5,1.5)));return d;}
...
{	
	...
	letters = min(letters,T(p.xy-vec2(-1.00,0.9)));
	letters = min(letters,R(p.xy-vec2(-0.50,0.9)));
	letters = min(letters,U(p.xy-vec2( 0.00,0.9)));
	letters = min(letters,M(p.xy-vec2( 11.5,0.9)));
	letters = min(letters,P(p.xy-vec2( 1.77,0.9)));
	letters = min(letters,I(p.xy-vec2( -1.,.2)));
	letters = min(letters,S(p.xy-vec2( -.5,.2)));
	letters = min(letters,D(p.xy-vec2( 0.,.2)));
	letters = min(letters,O(p.xy-vec2( .5,.2)));
	letters = min(letters,G(p.xy-vec2( 1.,.2)));
