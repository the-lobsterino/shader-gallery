...
//16 segment display 
// very secret code and maker.... do not use or abuse .. the troll will get you ;-)
...
void main( void ) 
{
	...
	ch[ 6] = 0.0;
	ch[ 7] = mix(0.0, c_r, clamp(anim_time - 6.0, 0.0, 1.0));
	ch[ 8] = mix(0.0, c_u, clamp(anim_time - 7.0, 0.0, 1.0));
	ch[ 9] = mix(0.0, c_l, clamp(anim_time - 8.0, 0.0, 1.0));
	ch[10] = mix(0.0, c_e, clamp(anim_time - 9.0, 0.0, 1.0));
