...
// Reply: even if it's true I don't care here. Let's keep glslsandbox politics free and code shaders intead
...
void main( void ) 
{
	...
	ch_pos = ch_start;
        ...
        _ P E O P L E _ W A T C H _ O U T nl2;
	
	uv *= 1.45;
	uv.x -= 1.0;
	W W W s_dot S H I T W E B C O M I C s_dot X Y Z _ nl2;
