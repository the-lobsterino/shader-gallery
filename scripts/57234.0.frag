...
uniform float time, size, connectivity, speed;
...
void main( void ) {
  float t = (time + 2586.9363) * 2. * speed, f, d;
vec3 bg1 = vec3(0.156, 0.160, 0.18);
    vec3 bg2 = vec3(0.03, 0.03, 0.03);
    vec3 fg  = vec3(1.0, 1.0, 1.0);
  float size = float(24);
  float speed = float(0.50);
  float connectivity = float(0.6);
  vec3 uv3 = aspect_ratio_1540259130(resolution, 0);
