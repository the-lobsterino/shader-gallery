...
void main()
{
	...
	grid += circleA(cen, RADIUS/1.2 + 1., .015);
	grid += circleA(cen, RADIUS/1.5 + 1., .015);
        grid += circleA(cen, RADIUS/2. + 1., .01);
	grid += circleA(cen, RADIUS/4. + 1., .01);
    ...
    green += grid + grid2;
    outColor = vec4(0.0, green, 0., 1.0);
    //outColor += vec4(0.0, 1. - green, 0., 0.0); 
