...
float map(in vec3 p)
{
	...
	for (float i = 0.0; i < 2.0; i++) {
		z.xz = rotate(z.xz, (42.*sin(time*0.5))*radians(i*sin((time*0.758)+10.0)));
		z.zy = rotate(z.yz, (23.*sin(time*0.4234000))*radians((i+sin(sin(time*0.05)+8.0))*sin(42.0+sin(0.05*time))*1.1234));
