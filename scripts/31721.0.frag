...
const float groundPosition = -2.5;
...
{	
	...
	vec2 tp = vec2(-1.,1.0);
	letters = min(letters,S(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,O(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,M(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,E(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	
	tp += vec2(-1.75,-0.67);
	letters = min(letters,L(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,I(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,V(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,E(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,S(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	...
	letters = min(letters,M(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,A(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,T(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,T(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,E(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
	letters = min(letters,R(p.xy-tp)+cos(time*(cos(length(tp)*10.-length(p)/64.)+0.7))*0.03);
	tp += vec2(.5,0.);
...
{	
	...
	gl_FragColor = vec4(1.-col*0.4,1.0);
}