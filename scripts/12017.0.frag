...
void main(void)
{
	...
	d += I(r()); space(); 
	d += M(r()); add(); d += A(r()); add(); d += D(r()); add(); d += E(r()); space();
	d += A(r()); space();
	d += R(r()); add(); d += A(r()); add(); d += Y(r());
	newline();
	
	d += T(r()); add(); d += R(r()); add(); d += A(r()); add(); d += C(r()); add(); d += E(r()); add(); d += R(r());  space();
	d += A(r()); add(); d += N(r()); add(); d += D(r()); space();
	d += N(r()); add(); d += O(r()); add(); d += W(r()); space();
	newline();
	
	d += I(r()); add(); d += T(r()); add(); d += S(r()); space();
	d += G(r()); add(); d += O(r()); add(); d += N(r()); add(); d += E(r());
