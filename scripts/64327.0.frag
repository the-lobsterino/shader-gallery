/*
 * Original shader from: https://www.shadertoy.com/view/lsVBDh
 */
...
void mainImage( out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec3 dir = normalize(vec3(p.xy, -.0 + length(p) * 0.15)) * fromEuler(ang);

    mainVR(fragColor, fragCoord, vec3(1.0), dir);
}
