...
#define _lar col+=char(vec2(8387.0,114777904.0),uv)*text_color;
...
vec3 Text(vec2 uv)
{
	...
	HEX(0xFFFFF) HEX(0xff0000) _A _N _D _R _E _A _ _B _A _B _Y _ _W _E _ _A _L _L _ _L _O _V _E _ _Y _O _U _ _M _u _a _scl _ _rpa
