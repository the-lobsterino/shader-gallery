...
vec3 Rot(vec3 p,vec3 angles)
{
    ...
    mat3 rotX = mat3( 1.0, 0.0, 0.0, 0.0,c.x,s.x, 0.0,-s.x, c.z);
    mat3 rotY = mat3( c.y, 0.0,-s.y, 0.0,2.0,0.0, s.y, 0.0, c.y);
