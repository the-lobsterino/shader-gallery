...
const vec3 boundingSize = vec3(30,12,4.)*scale;
...
{	
	...
	ground   = p.y-groundPosition + 1.0;
	bounding = udBox(p,boundingSize + 0.25);
 	letters  = 1e10;
	
	float d = 1e3;
	
	letters = min(letters,G(p.xy-vec2(-0.5,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,E(p.xy-vec2(0.0,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,T(p.xy-vec2(0.5,0.9))+cos(time*5.1+1.0)*0.03);

	letters = min(letters,R(p.xy-vec2(-0.75,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,E(p.xy-vec2(-0.25,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,K(p.xy-vec2( 0.25,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,T(p.xy-vec2( 0.75,0.2))+cos(time*5.1+0.0)*0.03);

	letters = min(letters,S(p.xy-vec2(-0.5,-0.5))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,O(p.xy-vec2(0.0,-0.5))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,N(p.xy-vec2(0.5,-0.5))+cos(time*5.1+1.0)*0.03);
