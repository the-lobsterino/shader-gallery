...
vec3 main2(void)
{
	...
	d = H(r()); add(); d += A(r()); add(); d += M(r()); add(); d += A(r()); add(); d += R(r()); d += O(r()); add(); d += S(r()); add(); d += A(r());; add(); d += N(r());  space();
	d += K(r()); add(); d += E(r()); add(); d += Z(r()); add(); d += D(r()); add(); d += E(r()); add(); d += K(r());  space();
	newline();
