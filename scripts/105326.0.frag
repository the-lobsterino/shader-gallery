...
#define colour_2 vec4(0.0,0.6,1.5,1.0)
#define colour_1 vec4(0.8,0.1,0.1,1.0)
...
void main( void )
{
    ...
    vec4 ret_col = (0.3/contrast)*colour_1 + (1. - 0.3/contrast)*(colour_1*c1p + colour_2*c2p + vec4(c3p*colour_3.rgb, c3p*colour_1.a)) + 0.2*max(c1p*5. - 4., 0.) + 0.3*max(c2p*5. - 4., 0.);
