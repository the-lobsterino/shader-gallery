/*
 * Original shader from: https://www.shadertoy.com/view/MlyXDV
 */
...
mat3 vuMat = mat3(0.);
vec3 balPos[N_BAL], qHit = vec3(0.), qHitFlm = vec3(0.), vuPos = vec3(0.), sunDir = vec3(0.);
float balRad = 0., flmCylRad = 0., flmCylLen = 0., tCur = 0., dstFar = 0.;
int idObj, idGrp;
