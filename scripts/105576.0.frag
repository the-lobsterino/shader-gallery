...
const float defaultSourceDistance3 = 0.000005;
...
const bool mouseZoom = false;
const bool mousePowerDisplay = false;

// Controls the amount of items at source
// If this is off, it's stuck at 2
...
//21
    shiftBlend = 1.0;
//32-50 2
    syncBlend = blend(100.0, maxt, 2., dt);
//41-48 71.5- 2
