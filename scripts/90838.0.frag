...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	float s = iTime;
	ro += (vec3(rand11(s), rand11(s - 11.11), rand11(s + 11.11)) * 2.0 - 1.0) * exp(fract(iTime * 0.8) * -10.0) * 0.02;
