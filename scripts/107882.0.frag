...
#define text() _D _e _f _i _a _n _t _spc _R _a _v _e _r _s
...
vec3 Text(vec2 uv) {
 ...
 //   BEGIN _TEXT(res.x/2.0-STRWIDTH(11.0)/2.0,res.y/2.0);
   print_pos += vec2(cos(time)*96.,sin(time)*96.);
     ...
     RGB(1,0,0) _U RGB(1,.5,0)_n RGB(1,1,0)_i RGB(0,1,0)_t RGB(0,.5,1)_e RGB(0.5,0,1)_spc RGB(1,1,0)_A RGB(0,1,0)_s RGB(1,.5,0)_spc RGB(1,1,0)_O RGB(0,1,0)_n RGB(1,1,0)_e
