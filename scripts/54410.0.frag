...
void main( void ) 
{
	...
	uv.x += -1.+sin(time+uv.y*0.27)*0.5;
	uv.y += -1.+sin(time+uv.x*0.27)*0.5;
	ch_pos = ch_start;

	           _ I G G Y E M _ I S _ G A Y  
			 nl1
			   
			   
			_ S O _ I S _ E V E R Y O N E
			   nl2
			   _ E L S E _ O N _ T H I S _ S E R V E R 
			   nl3
