...
{	
	...
	letters = min(letters,M(p.xy-vec2(-1.00,0.9)));
	letters = min(letters,U(p.xy-vec2(-0.50,0.9)));
	letters = min(letters,S(p.xy-vec2( 0.00,0.9)));
	letters = min(letters,L(p.xy-vec2( 0.50,0.9)));
	letters = min(letters,I(p.xy-vec2( 1.00,0.9)));
	letters = min(letters,M(p.xy-vec2( 1.50,0.9)));
