/*
	Idk if you know the croud your talking to, but we could give a fuck less.

	Trump isnt the president, there is a disease going around that is deadly.
	Grow up, and just move on, your clearly having a schizophrenic episode as you 
	keep copy pasting the same shit over and over again. Move on!
*/
...
const vec2 ch_start = vec2 (ch_space.x * -7., 5.0); // start position
...
#define nl5 ch_pos = ch_start;	ch_pos.y -= 15.0;
...
void main( void ) 
{
	...
	ch_pos = ch_start;
		...
		T R U M P _ B E A T _ T H E nl1
	        R I G G E D _ E L E C T I O N nl2 
			I N _ n2 n0 n1 n6 _ S O _ W E nl3
			C H E A T E D  _ H A R D E R nl4
		G E T _ O V E R _ I T
