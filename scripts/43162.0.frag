//Modified from: https://www.shadertoy.com/view/MslGD8ully
...
vec2 hash( vec2 p ) { p=vec2(dot(p,vec2(1227.1,311.7)),dot(p,vec2(269.5,183.3))); return fract(sin(p)*18.5453); }
