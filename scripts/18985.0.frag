...
void main( void ) {
	...
	color += sin( 10.0*position.y * (sin(time) + 2.1 ) );
  	color += sin( 1.1 + distance((10.0 + 80.0 * cos(time))* position, vec2(10.0+11.0*sin(time), 0.0+10.0*cos(time)) ));
	...
	color += 3.41 * cos(distance(position, vec2(4.25 * sin(time * 0.25), cos(time / 0.65))) + 8.0 * sin(time / 1.23));
  	color += 1.79 * sin(distance(position, vec2(2.25 * sin(time * 0.25), sin(time / 0.65))) + 10.0 * cos(time * 0.31));
