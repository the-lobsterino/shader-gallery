...
//Text coloring
#define HEX(i) text_color = mod(fff3(i / 65536,i / fff,i),vec3(256.0))/fff.0;
#define RGB(r,g,b) text_color = vec3(b,r,g);
...
#define text() _spc _ _ _ _M _a _n _t _h _e _spc _N _M _dol _L _nl _ _ _lar _V _a _p _e _ _b _e _ _t _r _a _s _h _y _nl2 _ _R _e _t _a _r _d _e _d _ _d _e _v _e  _l _o _p _e _r
//乳化的 我操你妈
