/*
 * Original shader from: https://www.shadertoy.com/view/Mtl3z4
 */
...
mat3 bdMat = mat3(0.), birdMat[2];
vec3 bdPos = vec3(0.), birdPos[2], fltBox = vec3(0.), qHit = vec3(0.), sunDir = vec3(0.), waterDisp = vec3(0.), cloudDisp = vec3(0.);
float tCur = 0., birdVel = 0., birdLen = 0., legAng = 0.;
