...
//            16 Segment Display Example v4.5              2017-02-03    
// see also:  http://glslsandbox.com/e#31038.1
//-------------------------------------------------------------------
...
void main( void ) 
{
  ...
  // display text
  n1 n6 s_minus S E G M E N T s_minus D I S P L A Y s_ddot  nl
  ...
  I N T E G E R s_ddot _ showInteger(ivalue);	  // wrong display!!!
  _ _ F L O A T s_ddot _ showFloatN(fvalue,4);	  // wrong precision!!!
