...
vec3 render(vec3 pos, vec3 dir) {
	...
	return 
		0.25*lighting(diffuse_pos, diffuse_pos + vec3(-8, 10, 10), diffuse.xyz) +
		0.25*lighting(diffuse_pos, diffuse_pos + vec3(-12, 10, 10), diffuse.xyz) + 
		0.25*lighting(diffuse_pos, diffuse_pos + vec3(-10, 10, 8), diffuse.xyz) + 
		0.25*lighting(diffuse_pos, diffuse_pos + vec3(-10, 10, 12), diffuse.xyz);
}
