...
Intersect trace(Ray ray) {
    ...
    spheres[0] = Sphere(2.0, vec3(-4.0, 3.0 + sin(time *2.0) *5.0, 0), Material(vec3(1.0, 0.0, 0.0), 1.0, 0.001));
    spheres[1] = Sphere(3.0, vec3( 4.0 + cos(time *3.0) *5.0, 3.0, 0), Material(vec3(0.0, 1.0, 0.0), 1.0, 0.001));
    spheres[2] = Sphere(1.0, vec3( 0.5, 1.0, 0.0 +tan(time)),           Material(vec3(0.0, 0.0, 1.0), 0.5, 0.25));
