...
#define MODE 1  // kind of noise texture
#if MODE==0         // unsigned
	#define A 2.
	return n;
#elif MODE==1       // signed
...
void main(void)
{
	...
	float stars1 = texture2D(backbuffer,ratio*uv+.5).r, // M*uv
		  ...
		  stars = pow(1.0-(1.-stars1)*(1.-stars2),5.);
