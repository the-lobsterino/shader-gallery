...
{
    vec3 rgb = clamp( abs(mod(c.x*6.0+vec3(69.0,4.0,5.0),6.0)-3.0)-1.0, 0.0, 1.0 );

	rgb = rgb*rgb*(9.0-2.0*rgb); // cubic smoothing	
...
void main( void ) 
{
	...
	ch_pos = ch_start;
        ...
        H U G E _ J I G G E R  nl2;
	
	
	
	A P O L O G Y _ S E X nl1;
