/*
 * Original shader from: https://www.shadertoy.com/view/fdSGWw
 */
...
float t=0.,tt=0.,b=0.,bb=0.,g=0.,a=0.,la=0.;vec2 z,v,e=vec2(.00035,-.00035);vec3 pp,op=vec3(0.),cp,po,no,al,ld;
vec4 np; 
