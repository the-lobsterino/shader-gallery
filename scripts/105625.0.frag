...
#define PIXEL_SIZE_FAC 222117.0
...
void main( void )
{
    ...
    for(int i=0; i < 5; i++) {
		...
		uv  += .81*mix(1.5,.2,sin(time+fract(time*2.)))*vec2(cos(5.1123314 + 0.353*uv2.y + speed*0.131121),sin(uv2.x - 0.113*speed));
		uv  -= .2*cos(uv.x + uv.y) - 1.0*sin(uv.x*0.711 - uv.y);
	}
