...
#define LIGHT_COLOR vec3(1.85,1.9,2.)
#define AMBIENT_COLOR vec3(.08,.083,0.)
#define FLOOR_COLOR vec3(1.,.7,.9)
#define ENERGY_COLOR vec3(-2.,.7,1.4)
