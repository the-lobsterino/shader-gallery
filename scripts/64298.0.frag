...
void main(void)
{
	...
	d += H(r()); add(); d += A(r()); add(); d += L(r()); add(); d += T(r()); add(); d += S(r()); space();
	d += M(r()); add(); d += A(r()); add(); d+= U(r()); add(); d += L(r()); add(); space();
	d += D(r()); add(); d += U(r()); add(); space();
	newline();
	d += F(r()); add(); d += I(r()); add(); d += S(r());  add(); d += H(r()); space();
	newline();
	d += F(r()); add(); d += L(r()); add(); d += A(r()); add(); d += W(r()); add(); d += C(r()); d += C(r()); add(); d += O(r()); add(); d += D(r()); add(); d += E(r()); add();
