...
vec3 Text(vec2 uv)
{
	...
	HEX(0xFF0000) _ _ _ _ _D _I _G _I _T _O _N _A _U _T _nl 
	HEX(0x0099FF) _ _ _ _ _ _ _D _I _G _I _T _O _N _A _U _T _nl
	HEX(0x00FF00) _ _ _ _ _ _D _I _G _I _T _O _N _A _U _T _nl
    	return col;
}
