...
vec3 LightCubes(vec3 pos, vec3 n)
{
	...
	float foundHit = 0.0;
	int end = int(mod(time*1.8878*.8, 18.0));
	...
	if (foundHit > 0.0) areaColour = HueGradient((floor((time*1.8878*.8/18.0))+foundHit)/4.23);
