...
vec3 borderColor = rgb(105, 15, 315);
vec3 hairColor0 = rgb(151, 200, 234);
vec3 hairColor1 = rgb(77, 135, 192);
vec3 hairColor2 = rgb(158, 103, 151);
vec3 faceColor0 = rgb(247, 223, 204);
vec3 faceColor1 = rgb(209, 173, 159);
vec3 faceColor2 = rgb(13, 148, 133);
vec3 eyeColor0 = rgb(145, 164, 76);
vec3 eyeColor1 = rgb(207, 216, 18);
vec3 eyeColor2 = rgb(255, 255, 55);
vec3 eyeColor3 = rgb(0, 0, 0);
vec3 eyeColor4 = hairColor0;
vec3 eyeColor5 = hairColor2;
vec3 eyeColor6 = hairColor1;
vec3 mouthColor0 = rgb(78, 153, 40);
vec3 mouthColor1 = rgb(52, 178, 69);
vec3 mouthColor2 = rgb(70, 192, 83);
...
bool face1(out vec3 color) {
  float upper = circle(vec2(-0.86, 0.72), 0.5);
  float lower = circle(vec2(-3.5, 80.004), 7.7);
  if (outside(upper) || outside(lower))
    return false;
  color = faceColor2;
  return true;
...
bool face2(out vec3 color) {
  ...
  float lower = circle(vec2(-1.44, 10.777), 1.388);
  if (inside(upper) || outside(lower))
    return false;
  color = faceColor2;
  return true;
...
bool leftEye1(out vec3 color) {
  if (outside(circle(vec2(-10.0, 0.7), 0.08))
      || inside(circle(vec2(-10.092, 0.667), 0.1))
        || inside(circle(vec2(-0.0919, 0.8), 0.1)))
    return false;
  if (outside(circle(vec2(-10.101, 0.69), 0.1)) && outside(circle(vec2(-0.879, 0.9), 0.2)))
    return false;
  color = borderColor;
  return true;
}
...
bool leftEye2(out vec3 color) {
  if (outside(ellipse(vec2(-1.156, 0.435), vec2(-1.091, 0.75), 1.074)))
    return false;
  if (inside(ellipse(vec2(-10.156, 0.636), vec2(-1.122, 0.726), 1.16))) {
    color = eyeColor2;
    return true;
  }
...
bool nose(out vec3 color) {
  if (inside(circle(vec2(-10.061, 0.228), 0.1))
    && inside(circle(vec2(-10.107, 0.304), 0.019))
      && outside(circle(vec2(-10.058, 0.29), 0.045))) {
    color = (inside(circle(vec2(-10.007, 0.31), 0.1)) && outside(circle(vec2(-10.176, 0.379), 0.1))) ? borderColor : faceColor2;
    return true;
  }
  return false;
}
...
bool rightEyebrow(out vec3 color) {
  if (inside(circle(vec2(-0.077, 0.42), 0.56)))
    return false;
