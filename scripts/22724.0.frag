...
// "Wild Ride" backdrop for "XD" by Gramsci 2015
// - using"Fractal Cartoon" by Kali
// - using Mr Doob's GLSL Sandbox
...
#define GAMMA 1.
#define SATURATION 1.65
#define detail .001
#define t iGlobalTime*.75


const vec3 origin=vec3(-1.5,.7,0.);
float det=0.0;
...
float sunsize=9.; // -max(0.,vvvv-.4)*5.; // responsive sun size
