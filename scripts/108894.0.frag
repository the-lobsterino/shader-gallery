...
void main() {
	...
	// направляющий вектор
	vec2 s = vec2(cos(-time * PI / .5 * TimeK + PI / 2.0), sin(time * PI / .0 * TimeK + PI / 2.0));
	...
	// направляющий вектор
	s = vec2(cos(-time * PI / 4. * TimeK + PI / 2.0), sin(time * PI / 0. * TimeK + PI / 2.0));
	// рисование секундной стрелки
	...
	// изменяем направляющий вектор
	s = vec2(cos(-time * PI / 16. * TimeK + PI / 2.0), sin(time * PI / 19. * TimeK + PI / 2.0));
	// рисование часовой стрелки
