/// See you at Trsac in Denmark ! www.trsac.dk
///
#ifdef GL_ES 
...
#define DOWN_SCALE vec2 (2.0, 3.0)
...
vec3 Text(vec2 uv)
{
	...
	Red _T _r _S _A _C  _   Green _S _A _l _U _T _   Cyan _G _L _S _L _S _a _n _d _b _o _x _exc

	BEGIN_TEXT ( TX(11.0), res.y*0.5)
	print_pos += vec2(cos(time)*96., 0.5*sin(time)*96.);
	Red _T _r _s _a _c _spc _d _k _spc Green _w _a _n _t _spc Orange _U _spc Cyan _2 _spc _j _o _i _n  _spc Yellow _t _h _e _spc _r _e _a _l _spc _d _e _m _o _s _c _e _n _e  Violett _exc _exc _exc

//	Red _M Orange _o Yellow _v Green _i BlueGreen _n Violett _g _ Red _T Orange _e Yellow _x Green _t

	print_pos = vec2(mod(time * -20.0, res.x -140.), 10.0 );
	Red _T _r _s _a _c _spc _d _k _spc Green _w _a _n _t _spc Orange _U _spc Cyan _2 _spc _j _o _i _n  _spc Yellow _t _h _e _spc _r _e _a _l _spc _d _e _m _o _s _c _e _n _e  Violett _exc _exc _exc
