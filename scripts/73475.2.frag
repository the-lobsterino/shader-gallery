...
void main(void) {
  	...
  	spheres[2] =  Sphere(2.0, vec3(1.5, 1.0, 14.+sin(time)*8.0), vec3(0.0, 0.0, 1.0));
	spheres[3] =  Sphere(1.0, vec3(sin(time)*8.0, 2.0, 15.0), vec3(1.0, 1.0, 0.0));
	spheres[4] =  Sphere(1.0, vec3((mouse.x-0.5)*30.,max((mouse.y-0.5)*15.,1.0),5.0), vec3(1.0,1.0,1.0));
