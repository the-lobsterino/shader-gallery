...
#define color2           vec3(1.0)  // vec3(0.4, 0.4, 1.0)
#define fixedRays        1          // 1 for fixed number of rays (in this case maxRays is the number used)       
#define minRays          3          // i guess 3 is a reasonable minimum
#define maxRays          16         // should be more than 3 because minRays is 3
#define speed            1.0
#define timeLength       8.0        // i guess it's in seconds (considering speed is set to 1.0)
#define rotation         1./2.      // 0.0 for static
#define spiralFactor     0.         // makes it a spiral if not 0.
