...
void main( void ) {
	...
	vec2 rnd = pixel*(vec2(rnd3, rnd4)-0.5)*0.04; // critter code copied from http://glsl.heroku.com/91/0
	...
	gl_FragColor += (vec4(rnd4,rnd3,rnd2,rnd1)-0.5)*0.0205 - 0.012; // error diffusion
