...
// Hi ! I'm a liberal fascist and I hate free speech and LOVE terrorists and black bloc anarchists
// recruiting any and all liberal fascists from colleges across America - Make America Suffer Again
// @dennishjorth
...
{	
	...
	letters = min(letters,B(p.xy-vec2(-0.75,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,I(p.xy-vec2(-0.25,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,G(p.xy-vec2( 0.25,0.9))+cos(time*5.1+1.0)*0.03);
	
	letters = min(letters,C(p.xy-vec2(-1.00,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,U(p.xy-vec2(-0.50,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,N(p.xy-vec2( 0.00,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,T(p.xy-vec2( 0.50,0.2))+cos(time*5.1+0.0)*0.03);
