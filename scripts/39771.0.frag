...
void main( void ) {
	...
	float y = 0.62 * sin(mouse.y * 11.0*position.x  - 30.0*time*0.01); //dabu pakapenisku krasu pareju ar sin funkciju, lai atrak vilnosas tad pareizina ar kkadu skaitli jo lielaks joa atrak vilnojas
	y = 1.0 / (00110. * abs(position.y - y));
