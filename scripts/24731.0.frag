...
{          
	...
	vec4 vDistSphere = vec4( GetDistanceBox( vSphereDomain, vec3(1.0) ), 2.0, vSphereDomain.xy);
...
vec3 GetLightPos()
{
	vec3 vLightPos = vec3(-1.0, 1.0, 3.0 * cos(time));
	#ifdef ENABLE_MONTE_CARLO        
