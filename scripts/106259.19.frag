...
float getAcc(float x, float y, float currentHeight)
{
	...
	neighbours[1] = pixel * vec2(1.,1.);
	neighbours[2] = pixel * vec2(1.,0.);
	neighbours[3] = pixel * vec2(1.,-1.);
	neighbours[4] = pixel * vec2(0.,-1.);
	neighbours[5] = pixel * vec2(-1.,-1.);
	neighbours[6] = pixel * vec2(-1.,0.);
	neighbours[7] = pixel * vec2(-1.,1.);
	neighbours[8] = pixel * vec2(-2.,0.);
	neighbours[9] = pixel * vec2(2.,0.);
	neighbours[10] = pixel * vec2(0.,-2.);
	neighbours[11] = pixel * vec2(0.,2.);
