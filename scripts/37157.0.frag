...
vec4 vBorderPosition = vec4(100.0, 100.0, 500.0, 300.0);
vec2 vBorderRadii = vec2(3.0, 3.0);
float vBlurRadius = 15.0;
...
void main(void) {
    ...
    gl_FragColor = vec4(max(value, 0.0), gl_FragColor.gb, max(value, 0.0));
}
