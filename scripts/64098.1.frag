/*
 * Original shader from: https://www.shadertoy.com/view/ltBfDt
 */
...
float random (in vec2 _st) { 
    return fract(sin(dot(_st.xy, vec2(40.9898,78.233))) * 43758.54531237);
}
...
float flare(in float angle,in float alpha,in float time){
   ...
   //	n = 1.0;
    ...
    float rotate = sin(angle*30.0 + sin(angle*15.0+alpha*4.0+t*30.0+n*5.0+alpha*4.0))*(.5 + alpha*1.5);
