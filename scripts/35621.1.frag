...
void main( void ) {
	...
	if (((fract(position.x) < (small / 2.0) || (fract(position.x) > 1.0 - (small / 2.0))) && abs(position.y) < 0.25)) {
		gl_FragColor = vec4(0.0, 0.0, 0.0, 0.0);
	}
	
	if (((fract(position.y) < (small / 2.0) || (fract(position.y) > 1.0 - (small / 2.0))) && abs(position.x) < 0.25)) {
		gl_FragColor = vec4(0.0, 0.0, 0.0, 0.0);
	}
}