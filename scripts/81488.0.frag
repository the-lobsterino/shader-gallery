...
#endif
//if you see this say hello to twitch and you are still a mother fucker 
// Streamer : pitgamer1909
...
const vec2 ch_start = vec2 (ch_space.x * -5., 1.); 
      ...
      vec3 ch_color = vec3 (1.5, 0.75, 0.5);        
...
void main( void ) 
{
	...
	Y O U R _ M u m _ S t u p i D _ M F
