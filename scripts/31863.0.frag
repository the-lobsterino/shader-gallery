...
{	
	...
	letters = min(letters,F(p.xy-vec2(-0.75,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,U(p.xy-vec2(-0.25,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,C(p.xy-vec2( 0.25,0.9))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,K(p.xy-vec2( 0.75,0.9))+cos(time*5.1+0.0)*0.03);
	
	letters = min(letters,I(p.xy-vec2(-1.00,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,S(p.xy-vec2(-0.50,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,L(p.xy-vec2( 0.00,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,A(p.xy-vec2( 0.50,0.2))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,M(p.xy-vec2( 1.00,0.2))+cos(time*5.1-1.0)*0.03);
