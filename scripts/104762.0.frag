...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    col = mix( col, getCol(0.07), brusha(uv,vec3(11.07,0.33,0.47)) );
    col = mix( col, getCol(0.19), brusha(uv,vec3(0.1,0.71,0.10)) );
    ...
    col = mix( col, getCol(-.700), brusha(uv,vec3(0.84,0.53,0.44)) );
