//Copyright (c) 2019-06-23 - 2019-07-06 by Angelo Logahd
...
vec3 sea(const in vec3 p, const in vec3 lightDir, const in vec3 eye) 
{
    ...
    vec3 emissive = SEA_EMISSIVE_COLOR * SEA_EMISSIVE_CONTRIBUTION; //Ändra stavningen till EMISSIVE
...
void main(void) 
{
    ...
    color.rgb = resLuminance * bloomIntensity;
    #endif
