...
vec3 Text(vec2 uv) 
{
	...
	HEX(0xFFAB00) _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _per _I _ _A _M _ _B _O _R _E _D _ _A _H _H _H _H _H _H;
	BEGIN_TEXT(res.x/2.0-STRWIDTH(11.0)/2.0,res.y/2.0)
	print_pos += vec2(cos(time)*96.,sin(time)*96.);
	
	RGB(1,0,0) _W RGB(1,.5,0)_E RGB(1,1,0)_E RGB(0,1,0)_E RGB(0,.5,1)_E RGB(0.5,0,1)_E RGB(1,0,0)_E RGB(1,.5,0)_E RGB(1,1,0)_E RGB(0,1,0)_E
