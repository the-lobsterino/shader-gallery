// complex sin(1/z*z-t) iterated 10 times
// irish sexy version
...
void main(void)
{
   ...
   gl_FragColor.r = 0.2+b*0.6;
   gl_FragColor.g = 0.3+(g*0.6+r*0.4)*0.55;
   gl_FragColor.b = 0.4+(g*0.4+r*0.6)*0.5;
#endif   
}