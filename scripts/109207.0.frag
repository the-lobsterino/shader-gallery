...
const bool cbSetting_March2nd_Reflect =true;	//反射
...
const bool cbSetting_Effect1st_After =false;	//特殊効果（応用）
const bool cbSetting_Effect2nd_Reflect_After =false;	//同、反射
const bool cbSetting_Effect2nd_Refract_After =false;	//同、屈折
...
float fNLetters00(vec4 VP){
	float NP =1e+6;
		{ float nE =float(1);  vec3 V3C =vec3(2.5,2.5,1) *nE,  V3D =vec3(5,0,0) *nE, V3P;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-2,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1.5) *nE; VB.xy =vec2(-0.5,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1.5) *nE; VB.xy =vec2(-0.5,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-0.5) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1) *nE; VB.xy =vec2(-0.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1) *nE; VB.xy =vec2(-0.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1) *nE; VB.xy =vec2(-0.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0.5) *nE; VB.xy =vec2(-1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(1,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2) *nE; VB.xy =vec2(0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,0.5) *nE; VB.xy =vec2(1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0.5) *nE; VB.xy =vec2(0.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5) *nE; VB.xy =vec2(2,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5) *nE; VB.xy =vec2(2,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-1) *nE; VB.xy =vec2(-0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1) *nE; VB.xy =vec2(0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-1) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-1.5) *nE; VB.xy =vec2(0,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1) *nE; VB.xy =vec2(2,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1) *nE; VB.xy =vec2(2,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1.5) *nE; VB.xy =vec2(1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,0.5) *nE; VB.xy =vec2(2,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(0,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0.5) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0.5) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-1,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1) *nE; VB.xy =vec2(-1.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-1,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-1,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2) *nE; VB.xy =vec2(0.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0) *nE; VB.xy =vec2(-0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0) *nE; VB.xy =vec2(-0.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2) *nE; VB.xy =vec2(1,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1.5) *nE; VB.xy =vec2(0,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-0.5) *nE; VB.xy =vec2(0,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-0.5) *nE; VB.xy =vec2(1.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-1,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1) *nE; VB.xy =vec2(-1.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1.5) *nE; VB.xy =vec2(-1.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1.5) *nE; VB.xy =vec2(-1.5,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-0.5) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-1,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-1,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,2) *nE; VB.xy =vec2(0.5,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2) *nE; VB.xy =vec2(0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2) *nE; VB.xy =vec2(0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1.5) *nE; VB.xy =vec2(0,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,1) *nE; VB.xy =vec2(0,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,1.5) *nE; VB.xy =vec2(1.5,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,1) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0.5) *nE; VB.xy =vec2(-0.5,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-0.5) *nE; VB.xy =vec2(0,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0) *nE; VB.xy =vec2(1,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-1) *nE; VB.xy =vec2(1.5,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-1.5) *nE; VB.xy =vec2(1.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;}
...
//目かずら部（R050512版）
int fIDMask_HeadKuma01(vec4 VP){
	int ID_Mask =200, ID =8;
	{
		vec4 VP =VP;
		VP.z =-VP.z;
		VP.xyz =vec3(atan(VP.x,VP.z),atan(VP.y,VP.z),length(VP.xyz));
		vec3 V3P;

		V3P =VP.xyz;
		V3P.x =abs(V3P.x);
		V3P.xy -=vec2(0.425, 0.6);
		if(length(V3P.xy) -0.125 <0.0) ID =9;
		V3P.y +=0.1;
		if(length(V3P.xy) -0.15 <0.0) ID =8;

		V3P =VP.xyz;
		V3P.x =abs(V3P.x);
		V3P.xy -=vec2(0.45, 0.3);
		if(length(V3P.xy) -0.2 <0.0) ID =9;

		V3P.x =abs(V3P.x) +0.06;
		if(length(V3P.xy) -0.1 <0.0) ID =10;
	}
	return ID +ID_Mask;
}
...
sface fSFAttachment_HeadKuma01(vec4 VP){
	int ID_Mask =200;
...

	{
		vec3 V3P =VP.xyz;
		V3P.y *=1.1;
		if(V3P.z <0.25 *nA)	V3P.z *=1.25; 
		float nPi =length(V3P) -1.05 *nA;
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Pallet =fIDMask_HeadKuma01(vec4(V3P, VP.w)) -ID_Mask;
		SF =fSFMin(SF, SFi);
	}

	{
		vec3 V3P =VP.xyz;
		V3P -=vec3(0,-0.2,-0.7) *nA;
		V3P.y *= 1.2;
		float nPi =length(V3P) -0.5 *nA;
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Pallet =9;

		V3P.y +=0.2 *nA;
		V3P.y =abs(V3P.y) +0.3 *nA *(cos(VP.w) *0.5 +0.5);
//		V3P.y *=2.0;
		if(length(V3P.xy) -(0.15 +0.25 *(cos(VP.w) *0.5 +0.5))*nA <0.0)	SFi.ID_Pallet =10;
	...
	{
		vec3 V3P =VP.xyz;	
		V3P -=vec3(0,-0.02,-1.2) *nA;
		V3P.x *= 0.8;
		float nPi =length(V3P) -0.15 *nA;
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Pallet =10;
		SF =fSFMin(SF, SFi);
	}

	{
		vec3 V3P =VP.xyz;	
		V3P.x =abs(V3P.x);
		V3P -=vec3(0.7,0.8,0.2) *nA;
		float nPi =length(V3P) -0.3 *nA;
		nPi =max(nPi,-V3P.z);
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Pallet =8;
		if(length(V3P) -0.2 *nA <0.0)	SFi.ID_Pallet =9;
...

	{
		vec3 V3P =VP.xyz;	
		V3P.x =abs(V3P.x);
		V3P -=vec3(0.8,-0.25,-0.6) *nA;
		float nPi =length(V3P) -0.25 *nA;
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Pallet =1;
...
sface fSFOutfit_Kuma01(sskelton SS){
	float NP =1e+6;
	vec4 VP =SS.VP;
	VP.xyz *=fM3Rotate(SS.VR_Cntr.xyz);
	...
	{
		vec3 V3P =fV3Attach(VP.xyz, SS.VP_Head.xyz, SS.VR_Head.xyz);
		sface SFi =fSFAttachment_HeadKuma01(vec4(V3P, VP.w));
		SF =fSFMin(SF, SFi);
	...
	{
		vec3 V3P =fV3Attach(VP.xyz, SS.VP_Body.xyz, SS.VR_Body.xyz);
		sface SFi =fSFSet_Default(length(V3P -vec3(0,-0.6,1) *nE) -0.4 *nE);
		SF =fSFMin(SF, SFi);
	}
...
sskelton fSSPSet_Kuma01(sskelton SS){
	SS.VP_Cntr;
	SS.VP_Body =vec4(0,	0,	0,	1.1);
	SS.VP_Shld =vec4(0,	1,	0,	0);
	SS.VP_Neck =vec4(0,	0.3,	0,	0.8);
	SS.VP_Head =vec4(0,	1,	0,	0);
	SS.VP_ArRU =vec4(+0.9,	0,	0,	0.4);
	SS.VP_ArLU =vec4(-0.9,	0,	0,	0.4);
...
sskelton fSSRSet_SaltBunny02P(sskelton SS){
	SS.VR_Cntr;
	SS.VR_Body =vec4(-90,	0,	0,	0);
	SS.VR_Shld =vec4(0,	0,	0,	0);
	SS.VR_Neck =vec4(-45,	0,	0,	1);
	SS.VR_Head =vec4(0,	0,	0,	1);
	SS.VR_ArRU =vec4(+30,	0,	0,	1);
	SS.VR_ArLU =vec4(+30,	0,	0,	1);
	SS.VR_ArRL =vec4(+15,	0,	0,	1);
	SS.VR_ArLL =vec4(+15,	0,	0,	1);
	SS.VR_LeRU =vec4(+45,	0,	+15,	0);
	SS.VR_LeLU =vec4(+45,	0,	-15,	0);
	SS.VR_LeRL =vec4(-90,	0,	0,	1);
	SS.VR_LeLL =vec4(-90,	0,	0,	1);
	SS.VR_HndR =vec4(0,	0,	0,	1);
	SS.VR_HndL =vec4(0,	0,	0,	1);
	SS.VR_FotR =vec4(0,	0,	0,	0);
	SS.VR_FotL =vec4(0,	0,	0,	0);

	SS =fSSRChange_Radians(SS);
	return SS;
}

sskelton fSSRSet_SaltBunny02N(sskelton SS){
	SS.VR_Cntr;
	SS.VR_Body =vec4(0,	0,	0,	0);
	SS.VR_Shld =vec4(0,	0,	0,	0);
	SS.VR_Neck =vec4(0,	0,	0,	1);
	SS.VR_Head =vec4(+45,	0,	0,	1);
	SS.VR_ArRU =vec4(0,	0,	+45,	1);
	SS.VR_ArLU =vec4(0,	0,	-45,	1);
	SS.VR_ArRL =vec4(0,	0,	0,	1);
	SS.VR_ArLL =vec4(0,	0,	0,	1);
	SS.VR_LeRU =vec4(+30,	0,	0,	0);
	SS.VR_LeLU =vec4(+30,	0,	0,	0);
	SS.VR_LeRL =vec4(-60,	0,	0,	1);
	SS.VR_LeLL =vec4(-60,	0,	0,	1);
	SS.VR_HndR =vec4(0,	0,	0,	1);
	SS.VR_HndL =vec4(0,	0,	0,	1);
	SS.VR_FotR =vec4(-30,	0,	0,	0);
	SS.VR_FotL =vec4(-30,	0,	0,	0);
...
sskelton fSSRSet_Salt01N(sskelton SS){
	float nS =sin(SS.VP.w *acos(-1.0) *2.0 *5.0);
	SS.VR_Cntr;
	SS.VR_Body =vec4(0,	0,	0,	0);
	SS.VR_Shld =vec4(0,	0,	0,	0);
	SS.VR_Neck =vec4(0,	0,	0,	1);
...
//総体部
float fNObject_SaltBunny02(vec4 VP){
	sskelton SS;
	SS.VP =VP;
	SS =fSSPSet_Bunny01( SS);
	SS =fSSChange_Inbetween(fSSRSet_SaltBunny02P( SS), fSSRSet_SaltBunny02N( SS), cos(radians(VP.w *180.0)));
	SS =fSSkeltonMake( SS);

	float NP =fNMin(fNMuscle_Animal01(SS), fNOutfit_Bunny01(SS), 12.0);
	return NP;
}

sface fSFObject_SaltKuma02(vec4 VP){
	sskelton SS;
	SS.VP =VP;
	SS =fSSPSet_Kuma01( SS);
	SS =fSSChange_Inbetween(fSSRSet_Salt01P( SS), fSSRSet_Salt01N( SS), cos(radians(VP.w *180.0)));
	SS =fSSkeltonMake( SS);

	sface SF_Body =fSFSet_Default(fNMuscle_Animal01(SS));
	SF_Body.ID_Pallet =8;
	SF_Body.VP =VP;
	sface SF_Outfit =fSFOutfit_Kuma01(SS);
	sface SF =fSFMin(SF_Body, SF_Outfit);
	return SF;
}
...
float fNMap(vec3 V3P){
	...
	if(true){	//バニーサルト熊本版
		...
		VPi.xyz =fV3Salt01(VPi, vec4(-int(VRandom.y *2.0),int(VRandom.z *3.0) ,0,16));
//		sface SFi =fSFSet_Default(fNObject_SaltBunny02(VPi));
		sface SFi =fSFObject_SaltKuma02(VPi);
		SFi.ID_Object =11;
//		SFi.ID_Pallet =51;
		if(SFi.ID_Pallet ==8)	SFi.ID_Pallet =51;
...
//色彩、反射率、屈折率変化
	...
	if(SF.ID_Pallet ==51){
		SF.VColor.rgb =VRandom_Misc00.rgb *0.5 +0.2;
	}
