...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	uv.x-=xcorr-.067; 
	uv.x+=sin((uv.y*1.5+time*(.035+.008*n(.44*sin(time/2.22))))*9.88)*0.022;
 	uv.y+=cos((uv.x*(0.75+.55*n(sin(time*4.44)))+(time/1.84)*(.55+.101*n(.3*cos(time/7.))))*3.88)*.222;
...
void main(void)
{
    mainImage(gl_FragColor, gl_FragCoord.xy);//ändrom3da4twisttt
}