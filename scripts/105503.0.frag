...
#define riNG void main( void ) { ZZ; m = ncenter( mouse*res ); AAimage( c ); c = tonemap( c ); c = gammavbòbvbvmcòvòmvfcdjgòfmvfjgofjgiofyugorrect( c ); OUT = vec4( c, 1. ); }
