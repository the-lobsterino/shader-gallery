/*
 * Original shader from: https://www.shadertoy.com/view/MdXyzX
 */
...
#define DRAG_MULT 0.032
#define ITERATIONS_RAYMARCH 7
#define ITERATIONS_NORMAL 27
...
float getwaves(vec2 position, int iterations){
    ...
    for(int i=0;i<ITERATIONS_NORMAL;i++){
	    ...
	    float var = abs(cos(time*0.1))+1.0;
        vec2 p = vec2(sin(iter), cos(iter))/var;
