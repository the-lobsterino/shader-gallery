/*R050219作例　月面兎返り　by ニシタマオ　THE SEA PANTHER*/
...
float fNLetters00(vec4 VP){
	float NP =1e+6;
		{ vec3 V3C =vec3(2.5,2.5,1),  V3D =vec3(5,0,0), V3P;V3P.y +=V3C.y;V3P.y +=V3C.y;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(0,2); VB.xy =vec2(0,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1); VB.xy =vec2(-2,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1.5); VB.xy =vec2(2,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1.5); VB.xy =vec2(2,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0); VB.xy =vec2(1.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0); VB.xy =vec2(1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-2); VB.xy =vec2(-1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-2); VB.xy =vec2(-1.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0); VB.xy =vec2(1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-2); VB.xy =vec2(-1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-2); VB.xy =vec2(-1.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-2); VB.xy =vec2(-1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-2); VB.xy =vec2(-1.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-2); VB.xy =vec2(-1.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1); VB.xy =vec2(0,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1); VB.xy =vec2(1.5,-1); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,2); VB.xy =vec2(-1,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1); VB.xy =vec2(-1,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(-0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(-0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(-0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(-0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2); VB.xy =vec2(0.5,2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2); VB.xy =vec2(0.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0); VB.xy =vec2(0,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,2); VB.xy =vec2(0.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0); VB.xy =vec2(0,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0); VB.xy =vec2(0,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1); VB.xy =vec2(0.5,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1); VB.xy =vec2(0.5,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0.5); VB.xy =vec2(2,-1.5); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,2); VB.xy =vec2(-2,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;V3P =vec3(0);V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-1,2); VB.xy =vec2(-2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1); VB.xy =vec2(-1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1.5); VB.xy =vec2(2,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,1.5); VB.xy =vec2(1.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0); VB.xy =vec2(0.5,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0); VB.xy =vec2(0.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5); VB.xy =vec2(0,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5); VB.xy =vec2(0,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,0); VB.xy =vec2(0.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5); VB.xy =vec2(0,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5); VB.xy =vec2(0,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-0.5); VB.xy =vec2(0,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5); VB.xy =vec2(0,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-0.5); VB.xy =vec2(0,0); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(0.5,2); VB.xy =vec2(0.5,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1.5); VB.xy =vec2(-1.5,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1.5); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1.5); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0.5); VB.xy =vec2(2,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1); VB.xy =vec2(0,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0); VB.xy =vec2(1,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0); VB.xy =vec2(1,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0); VB.xy =vec2(1,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0); VB.xy =vec2(1,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0); VB.xy =vec2(1,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-0.5); VB.xy =vec2(1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-1); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,2); VB.xy =vec2(2,2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2); VB.xy =vec2(-1,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2); VB.xy =vec2(-1,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,3); VB.xy =vec2(2,2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(3,3); VB.xy =vec2(3,2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2); VB.xy =vec2(1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-1); VB.xy =vec2(0,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-1,2); VB.xy =vec2(1,2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2); VB.xy =vec2(-2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2); VB.xy =vec2(-2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,0); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2); VB.xy =vec2(-1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-2); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,-1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;V3P =vec3(0);V3P.y -=V3C.y;V3P.y -=V3C.y;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-1,2); VB.xy =vec2(-2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,1); VB.xy =vec2(-1,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1); VB.xy =vec2(0,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1); VB.xy =vec2(0.5,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,1); VB.xy =vec2(1.5,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0); VB.xy =vec2(2,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1); VB.xy =vec2(2,-1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1.5); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-1.5); VB.xy =vec2(-0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1.5); VB.xy =vec2(0.5,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-1.5); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(1,2); VB.xy =vec2(-1,1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0.5); VB.xy =vec2(1.5,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0.5); VB.xy =vec2(1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5); VB.xy =vec2(-1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-0.5); VB.xy =vec2(-1.5,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,0.5); VB.xy =vec2(1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5); VB.xy =vec2(-1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-0.5); VB.xy =vec2(-1.5,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1.5,-0.5); VB.xy =vec2(-1.5,-0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-0.5); VB.xy =vec2(-1.5,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-0.5); VB.xy =vec2(-1.5,0.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0); VB.xy =vec2(1,0); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1.5); VB.xy =vec2(1.5,-1.5); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2); VB.xy =vec2(2,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1.5); VB.xy =vec2(0,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ vec4 VA, VB; VA.w =float(1);{ VA.xy =vec2(-2,1); VB.xy =vec2(2,1); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,1); VB.xy =vec2(1,-2); NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2); VB.xy =vec2(-2,-2); NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;}
...
sskelton fSSRSet_SaltBunny01(sskelton SS){
	float nD =acos(-1.0) /180.0, nSR =-cos(SS.VP.w *acos(-1.0)), nSL =-cos((SS.VP.w +30.0/180.0)*acos(-1.0));
	SS.VR_Cntr;
...
float fNObject_SaltBunny01(vec4 VP){
	sskelton SS;
	SS.VP =VP;
	SS =fSSPSet_Bunny01( SS);
	SS =fSSRSet_SaltBunny01( SS);
	SS =fSSkeltonMake( SS);
...
/*個別デモ用関数*/
/*喜平鎖（R041118版）*/
float fNObject_KiheiRing01(vec4 VP){
	float NP =1e+6, nPi, nE =1.0, nRadius0 =2.0 *nE, nRadius1 =0.75 *nE, nL =2.0 *nE, nRotate =0.2, nRotate_Limit =0.5;
	vec4 VPi;

	VP.yz *=fM2Rotate(clamp(VP.x *nRotate, -nRotate_Limit, +nRotate_Limit));

	VPi =VP;
	VPi.x =abs(VPi.x) -nL;
	nPi =length(vec2(length(VPi.xy) -nRadius0, VPi.z)) -nRadius1;
	if(VP.x < -nL || VP.x > +nL)	NP =min(NP, nPi);

	VPi =VP;
	VPi.y =abs(VPi.y) -nRadius0;
	nPi =length(VPi.yz) -nRadius1;
	if(VP.x > -nL && VP.x < +nL)	NP =min(NP, nPi);

	return NP;
}

float fNObject_KiheiRing02(vec4 VP){
	float nE =1.0, nZ_Limit =1.2 *nE;
	float NP =fNObject_KiheiRing01(VP);
	NP =max(NP, abs(VP.z) -nZ_Limit);

	return NP;
}

float fNObject_KiheiRing03(vec4 VP){
	float nE =1.0, nY_Limit =2.25 *nE, nAngle =0.75;
	float NP =fNObject_KiheiRing02(VP);
	NP =max(NP, abs(VP.z *nAngle) +abs(VP.y *nAngle) -nY_Limit);
...
float fNMap(vec3 V3P){
	...
	if(true){	/*バニーサルト*/
		...
		float nPi =fNObject_SaltBunny01(VPi);
		sface SFi =fSFSet_Default(nPi);
		SFi.ID_Object =11;
		SFi.ID_Pallet =int(VRandom.w *8.0) +1;
		SF =fSFMin(SF, SFi);		
	}
	...
	if(false){	/*柱*/
		for(int I =0; I <=1; I++){
			vec4 VPi =VP;
			VPi.y +=VPi.w;
			VPi.xz =mod(VPi.xz, 25.0) -12.5;
			VPi.xy =VPi.yx;
			VPi.yz *=fM2Rotate(VPi.x *0.02);
			VPi.x =mod(VPi.x +float(I) *5.0, 10.0) -5.0;
			float nPi =fNObject_KiheiRing03(VPi);
			sface SFi =fSFSet_Default(nPi);
			SFi.VP =VP;
			SF =fSFMin(SF, SFi);
		}
...
sface fSFEffect_Before(sface SF, smarch SM){
	...
	if(SF.ID_Object ==101)	VColor.rgb =mix(sign(sin(VP.x) *sin(VP.z)), 1.0, 0.9) *vec3(1);
