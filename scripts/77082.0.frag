...
yawn. did you expect something?

A: Ugly you say? I guess you've never seen what my co-workers write . . .
...
void main( void ) 
{
	...
	vec3 color = mix(ch_color, bg_color, 1.0- (10./exp(time) / d*2.0));  // shading
