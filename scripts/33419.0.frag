...
void main( void ) {
	goTYPE ;
	cpos.y -= 3.;
	{inCYA}_ _ LPAREN BLOCK EQUAL DASH DASH DASH DASH EQUAL BLOCK RPAREN
	slashN ;
	{inWHT}_ _ _ _  O U T L A W
	slashN;
	{inWHT}_ _ _ _ _ L A W S 
	slashN;
	{inCYA}_ _ LPAREN BLOCK BLOCK EQUAL DASH DASH EQUAL BLOCK BLOCK RPAREN
	...
	gl_FragColor *= 0.92 + 0.08*fract(gl_FragCoord.x/5.)*5.;
}
