...
const vec3 clockLineSecCol = vec3(.0, 1.0, 1.0);
// цвет минутной стрелки
const vec3 clockLineMinCol = vec3(.0, 1.0, 1.0);
// цвет часовой стрелки
const vec3 clockLineHourCol = vec3(.0, 1.0, 1.0);
// цвет секундной стрелки
const vec3 clockLineSec2Col = vec3(.0, 1.0, 1.0);
// цвет минутной стрелки
const vec3 clockLineMin2Col = vec3(.0, 1.0, 1.0);
// цвет часовой стрелки
const vec3 clockLineHour2Col = vec3(0.0, 1.0, 1.0);
