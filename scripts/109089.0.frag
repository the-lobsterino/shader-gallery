...
vec3 Text(vec2 uv)
{
	...
	HEX(0x00FF7F) _E _m _o _r _t _a _l _i _t _y _spc _tid _spc _b _e _s _t _nl _b _o _t _spc _c _l _i _e _n _t _spc _lsb _D _E _U _S _spc _L _O _O _Z _E _R _rsb
