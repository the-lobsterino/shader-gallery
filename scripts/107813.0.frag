// chatGPT , give me alot naked chicks
// chatGPT , make thouse bitchs more sexy
// chatGPT , add some scrolling lines behind the bitchs
// chatGPT , change the colors bruh
// chatGPT , bitchs needs nipples
// chatGPT , give me a nike shoe bitch
