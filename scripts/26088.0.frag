...
void main(void)
{
	...
	float sides = 4.3;
	float rings = 13.3;
    float w = cos(2.1*td8-r);
    float h = 0.75+0.5*cos(sides*a-w*sides*rings+r*2.7182818);
    float d = 1.2;
	d*=pow(h,1.2*r)*(0.75+0.1*w);

    float col = u( d-r ) * sqrt(1.0-r/d)*r*1.667;
