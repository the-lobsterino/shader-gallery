...
#define goTYPE vec2 p = ( gl_FragCoord.xy /resolution.xy ) * vec2(64,32);vec3 c = vec3(0);vec2 cpos = vec2(1,29);vec3 txColor = vec3(1);
...
void main( void ) {
	...
	W O W _ Y O U ASTPHB R E _ G A Y DOT slashN
	K I L L _ Y O U R S E L F DOT slashN
