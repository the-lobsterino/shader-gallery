...
const float hfpi = 1.57073216916398; //0.5 x pi
...
{
  return vec4(sin(pos.x*2.0*pi+time)+1.0, sin(pos.x*2.0*pi+pi*1.0/3.0)+1.0, sin(pos.x*2.0*pi+time*0.99+pi*2.0/3.0)+1.0, 1.0)*(sin(pos.y*8.0*pi)+1.0)*0.7;
}
void main()
{
