...
void main( void ) {
	goTYPE
		W H Y _ D O N _ T slashN
		inBLU R A Z O R _ n1 n9 n9 n1 slashN
		inWHT G E T  _ G R E E T I N G S slashN
		inBLU I N _ D E M O S DOT DOT DOT slashN
		// Well not much greetings
//what about "?", "!" and """ ?? And is there a way to use those defines inside real functions?!
