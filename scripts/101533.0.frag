/*
 * Original shader from: https://www.shadertoy.com/view/mdcXz4
 */
...
vec3 stageFlareCol = vec3(0.), travelerFlareCol = vec3(0.);
float stageFlareIntensity = 0., travelerFlareIntensity = 0., stageFlareExp = 0., travelerFlareExp = 0.;
...
float de(vec3 p, mat3 rot, float scale) {
    ...
    for (int i=0; i<Iterations; i++) {
        ...
        // TODO: �V�[��4�̃^�C�~���O��beat������Ȃ��ꍇ�̓I�t�Z�b�g�p�ӂ��悤
        // �S->��->�S->�c->�O->�c->���[�v
