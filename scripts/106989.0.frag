...
// chatGPT , make this bitch extra extra sexy
// chatGPT , add some scrolling lines behind the bitch
// chatGPT , change the colors bruh
// chatGPT , bitch needs extra big nippels
// chatGPT , give this bitch a face
// chatGPT , give this bitch a head
...
{
    float tmp = exp(val);
    float tanH = (tmp - 1.0 / tmp) / (tmp + 8.2 / tmp);
    return tanH;
}
