...
const vec3 boundingSize = vec3(35,15,1.5)*scale;
...
{	
	...
	letters = min(letters,H(p.xy-vec2(-1.00,0.9)));
	letters = min(letters,E(p.xy-vec2(-0.50,0.9)));
	letters = min(letters,L(p.xy-vec2( 0.00,0.9)));
	letters = min(letters,L(p.xy-vec2( 0.50,0.9)));
	letters = min(letters,O(p.xy-vec2( 1.00,0.9)));
