...
vec3 Text(vec2 uv)
{
	...
	// Feel free to edit:
	_P _l _e _a _s _e _ _e _d _i _t _ _d _e _e _z _ _n _u _t _s _ _i _n _t _o _ _y _o _u _r _ _m _o _u _t _h _per
...
void main( void )
{
	...
	vec3 col = pixel*01.9+0.1;
	col *= (1.-distance(mod(uv,vec2(1.0)),vec2(.65)))*1.2;
