...
{   
    ...
    {
        // Rainbow effect
        float rainbowFactor = cos(position.y * 0.1 - time) * 0.5 + 0.5;
        color = vec3(0.5 + 0.5 * cos(6.2831 * rainbowFactor + 0.0),
                     0.5 + 0.5 * cos(6.2831 * rainbowFactor + 2.0944),
                     0.5 + 0.5 * cos(6.2831 * rainbowFactor + 4.18879));
    ...
    else
    {
        ...
        if(abs(position.x) < 105.0 && abs(position.y) <60.0) color = vec3(1.0, 1.0, 1.0);
