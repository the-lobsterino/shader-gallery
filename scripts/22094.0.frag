...
// Source edited by Yinqiang      - 2014.
...
void main(void)
{
    ...
    // UNIX
    d += U(r()); add(); d += N(r()); add(); d += I(r()); add(); d += X(r()); add();
    newline();

    // Where is a shell
    d += W(r()); add(); d += H(r()); add(); d += E(r()); add(); d += R(r()); add(); d += E(r()); add(); space();
    d += I(r()); add(); d += S(r()); add(); space();
    d += A(r()); add(); space();
    d += S(r()); add(); d += H(r()); add(); d += E(r()); add(); d += L(r()); add(); d += L(r()); add();
    newline();

    // There is a way
    d += T(r()); add(); d += H(r()); add(); d += E(r()); add(); d += R(r()); add(); d += E(r()); add(); space();
    d += I(r()); add(); d += S(r()); add(); space();
    d += A(r()); add(); space();
    d += W(r()); add(); d += A(r()); add(); d += Y(r()); add();
