...
//-------------------------------------------------------------------
// SixteenSegmentDisplayV3.glsl                   2015-11-03
// 16 Segment Display Example v4.1
...
void main( void ) 
{
  ...
  uv *= 20.0 + sin(3. * time);     //  set zoom size

  ch_pos = ch_start + vec2(sin(time),4.0);  // set start position
       
  ch_color = vec3 (2.6 - 4.*mouse.x, 1.2-mouse.x*mouse.y, 0.5+mouse.y);
  nl 
T H E R E _  A R E _ nl 
  O N L Y _ T W O _ K I N D S _ O F _ P E O P L E  nl
  T H O S E _ W H O _ D I V I D E nl 
  T H E _ W O R L D _ I N T O _ T W O nl
  A N D _ T H E _ R E S T _ O F _ U S _ nl
