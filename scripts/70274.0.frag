...
letters = min(letters,A(p.xy-vec2(-1.70,0.9)));
letters = min(letters,K(p.xy-vec2(-1.20,0.9)));
letters = min(letters,E(p.xy-vec2(-0.70,0.9)));
//letters = min(letters,L(p.xy-vec2(-0.25,0.9)));
letters = min(letters,O(p.xy-vec2( 0.25,0.9)));
letters = min(letters,M(p.xy-vec2( 0.75,0.9)));
letters = min(letters,E(p.xy-vec2( 1.25,0.9)));
//letters = min(letters,L(p.xy-vec2(1.75,0.9)));
;
