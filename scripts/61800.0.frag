// Ncp's : Original transfer from https://www.shadertoy.com/view/4tlXWs
...
// Xor - Triangle Grid, 	https://www.shadertoy.com/view/
...
vec3 doMaterial( in vec3 pos, in vec3 nor )
{
    ...
    float border = 12.0 * mod(time * 0.2, 1.0);
...
float calcSoftshadow( in vec3 ro, in vec3 rd )
{
	...
	float h = 1.0;
    for( int i=0; i<100; i++ )         // 40 is the max numnber of raymarching steps
    {
        h = doModel(ro + rd*t);
