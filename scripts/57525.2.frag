...
#define distfading 0.350
#define saturation 0.800
#define transverseSpeed zoom*.001
...
void main() {
	...
	from.x += transverseSpeed*(1.0)*cos(0.01*time) + 0.0001*time;
	from.y += transverseSpeed*(1.0)*sin(0.01*time) +0.0001*time;
	from.z += 0.008*time;
	...
	backCol2.b *= 1.8;
	backCol2.r *= 0.05;
	backCol2.b = 0.7*mix(backCol2.g, backCol2.b, 0.8);
	backCol2.g = 0.0;
