/*
 * Original shader from: https://www.shadertoy.com/view/Mtf3zM
 */
...
int idObj = 0;
mat3 fishMat = mat3(0.), vuMat = mat3(0.);
vec3 fishPos = vec3(0.), qHit = vec3(0.), sunDir = vec3(0.), tankSize = vec3(0.), waterDisp = vec3(0.), cloudDisp = vec3(0.);
float tCur = 0., fishLen = 0., angTail = 0., angFin = 0., posMth = 0.;
bool inTank = false, chkTank = false;
