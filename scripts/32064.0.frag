...
vec3 processColor(vec3 p)
{
	...
	float spec = pow(diff*diff, 20.0);
	
	if (ground<d) { col = vec3(diff+spec*0.3)*vec3(0.4,0.3,0.6); d = ground; }
...
{	
	...
	float d = 1e3;
	float offset = +0.55;
	letters = min(letters,W(p.xy-vec2(-1.50,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,H(p.xy-vec2(-1.00,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,I(p.xy-vec2(-0.50,0.9))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,T(p.xy-vec2(-0.00,0.9))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,E(p.xy-vec2( 0.50,0.9))+cos(time*5.1-1.0)*0.03);
	letters = min(letters,G(p.xy-vec2(-1.25-offset,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,E(p.xy-vec2(-0.75-offset,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,N(p.xy-vec2(-0.25-offset,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,O(p.xy-vec2( 0.25-offset,0.2))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,C(p.xy-vec2( 0.75-offset,0.2))+cos(time*5.1-1.0)*0.03);
	letters = min(letters,I(p.xy-vec2( 1.25-offset,0.2))+cos(time*5.1-2.0)*0.03);
	letters = min(letters,D(p.xy-vec2( 1.75-offset,0.2))+cos(time*5.1-3.0)*0.03);
	letters = min(letters,E(p.xy-vec2( 2.25-offset,0.2))+cos(time*5.1-4.0)*0.03);
