...
{	
	...
	letters = min(letters,H(p.xy-vec2(-1.00,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,E(p.xy-vec2(-0.50,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,L(p.xy-vec2( 0.00,0.9))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,L(p.xy-vec2( 0.50,0.9))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,O(p.xy-vec2( 1.00,0.9))+cos(time*5.1-1.0)*0.03);
	
	letters = min(letters,W(p.xy-vec2(-1.00,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,O(p.xy-vec2(-0.50,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,R(p.xy-vec2( 0.00,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,L(p.xy-vec2( 0.50,0.2))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,D(p.xy-vec2( 1.00,0.2))+cos(time*5.1-1.0)*0.03);
	
	// Trump for 2016, Trump for life
