...
//----------------------------------------------------------
// Starting a game with this, don't try to find out who I am.
// Try not to touch the other balls for 30 seconds, when you make it, increase the number by changing the first value, "#define NUMmb 3" to anything higher.
// try to do 1-2 more at a time, the number increases the ball count.
//----------------------------------------------------------
