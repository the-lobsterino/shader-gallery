...
#define HueSpeed 2.0
#define HueSeed 2.0 * iTime
#define BRIGHTNESS 3.2
...
void mainImage( void )
{
	...
	Color = clamp(Color*Color,  BRIGHTNESS, 9.) * 0.5 + 0.5*cos(mix(iTime*HueSpeed,HueSeed,HueSeed*2.0)+uv.xyx+vec3(0,2,4)) * huePower;
