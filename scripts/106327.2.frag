...
#define otime floor(1e-1*time*what(mouse))
#define time otime
...
//#define time ((floor(surfaceSize.x*surfaceSize.y)*2.0-1.0)*(mod(time,2.0)-1.0))
//#define time (1.0+TAU)
//#define time (mod(time*PI/4.0,2.0)-1.0)
//#define time (PI/4.0-otime)
