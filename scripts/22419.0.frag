...
vec3 tunnel( vec2 o, float scrollSpeed, float rotateSpeed )
{    
    vec2 p;
    p.x = o.x + sin(o.x*0.3+cos(o.y*0.3)*time*0.4+time*0.3)*0.4;
    p.y = o.y + cos(o.y*0.3+cos(o.x*0.3)*time*0.4+time*0.3)*0.4;
...
void main(void)
{
    ...
    float f = 0.7;
    finalColor += tunnel( p , 2.0, sin(time*0.01)) * 0.2;
