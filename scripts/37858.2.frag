//----------------------------------------------------------------------------
// Sierpinski3D.glsl               2016-01-13
//   original by inigo quilez (iq) 2013-10-26
//   https://www.shadertoy.com/view/4dl3Wl
//   License Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License.
// Modification: mouse.y changes iteration deep
// Tags: 3d, raymarching, fractal, distancefield, distance, sierpinski, gtc2015
//----------------------------------------------------------------------------
...
void main()
{
  ...
  {
    m = mouse.xy;
    iterations = 3 + int(m.y * 6.0);
    m.y = 0.4;
  }

  // camera
  float an = 0.15*time - 5.*(m.x-0.5);
