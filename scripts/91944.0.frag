...
#define STUFF vec2 p = ( gl_FragCoord.xy /resolution.xy ) * vec2(64,32);vec3 c = vec3(0);vec2 cpos = vec2(1,26);vec3 txColor = vec3(1);
#define STUFF2 gl_FragColor = vec4(c, 1.0);
...
#define LAB c += txColor*Sprite3x5(1024.+256.+16.,floor(p-cpos));cpos.x += 4.;if(cpos.x > 61.) slashN
#define RAB c += txColor*Sprite3x5(128.+2048.+32.,floor(p-cpos));cpos.x += 4.;if(cpos.x > 61.) slashN
#define SLASH c += txColor*Sprite3x5(128.+512.+32.,floor(p-cpos));cpos.x += 4.;if(cpos.x > 61.) slashN
#define UNDER c += txColor*Sprite3x5(7.,floor(p-cpos));cpos.x += 4.;if(cpos.x > 61.) slashN
...
#define ASTPHB c += txColor*Sprite3x5(25856.,floor(p-cpos));cpos.x += 3.;
...
void main( void ) {
	...
	STUFF;
		S O M E B O D Y _ H E L P _ M E
		I _ W I L L _ D I E _ I N slashN
		n3 n0 _ M I N U T E S slashN
		H E L P _ M E _ Y A Y  EXCLAM 
