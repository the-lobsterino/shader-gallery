...
const float TRESHOLD = 0.0003;
const float EPSILON = 1e-5;
 vec3 RED = vec3(1.0,0.2,0.0);
 vec3 ORANGE = cos(vec3(1.0,sin(time*0.67),0.43));
 vec3 BLUE = sin(vec3(time+0.34,0.3*time-0.77,1.0));
...
float map(vec3 p) {
    const float M = 0.37;
    float time = iGlobalTime + rsq(iGlobalTime*0.825) * 1.5;
    return julia(p,vec4( 
