...
// from the Shadertoy version here https://www.shadertoy.com/view/lsSXzD
...
const vec2 vFakeResolution = vec2(256.0, 192.0);
...
vec3 g_vRayOrigin = vec3(0.0);
vec3 g_vRayDir = vec3(0.0);
vec2 g_vSpriteDir = vec2(0.0);
...
#ifdef MOUSE_CONTROL
    {
        vec2 vDir = vec2(0.0,1.0);
        vec2 vOffset = mouse.xy - 0.5;
		vCameraPos.y = 30.0;
