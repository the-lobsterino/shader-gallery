/*
 * Original shader from: https://www.shadertoy.com/view/Xl2BRR
 */
...
void init_anim_data()
{
    ...
    HEAD[1] = vec3(73,30,0);
    HEAD[2] = vec3(94,20,0);
    HEAD[3] = vec3(117,15,0);
    HEAD[4] = vec3(85+50,24,0);
    HEAD[5] = vec3(85+73,30,0);
    HEAD[6] = vec3(85+94,20,0);
    HEAD[7] = vec3(85+117,15,0);
    HEAD[8] = vec3(168+50,24,0);
    SHOULDER[0] = vec3(44,47,16);
    SHOULDER[1] = vec3(66,53,16);
    SHOULDER[2] = vec3(91,43,16);
    SHOULDER[3] = vec3(115,38,16);
    SHOULDER[4] = vec3(85+51,50,16);
    SHOULDER[5] = vec3(85+73,55,16);
    SHOULDER[6] = vec3(85+91,43,16);
    SHOULDER[7] = vec3(85+111,37,16);
    SHOULDER[8] = vec3(168+44,47,16);
    ELBOW[0] = vec3(25,68,25);
    ELBOW[1] = vec3(46,71,25);
    ELBOW[2] = vec3(88,74,25);
    ELBOW[3] = vec3(120,69,25);
    ELBOW[4] = vec3(85+54,66,25);
    ELBOW[5] = vec3(85+87,71,25);
    ELBOW[6] = vec3(85+91,75,25);
    ELBOW[7] = vec3(85+92,65,25);
    ELBOW[8] = vec3(168+25,68,25);
    WRIST[0] = vec3(20,90,15);
    WRIST[1] = vec3(35,81,20);
    WRIST[2] = vec3(88,106,25);
    WRIST[3] = vec3(128,94,25);
    WRIST[4] = vec3(164,85,15);
    WRIST[5] = vec3(85+102,86,20);
    WRIST[6] = vec3(85+88,104,25);
    WRIST[7] = vec3(85+82,86,20);
    WRIST[8] = vec3(168+20,90,15);
    HIP[0] = vec3(42,90,10);
    HIP[1] = vec3(62,95,10);
    HIP[2] = vec3(83,88,10);
    HIP[3] = vec3(107,83,10);
    HIP[4] = vec3(127,92,10);
    HIP[5] = vec3(147,94,10.);
    HIP[6] = vec3(168,91,10);
    HIP[7] = vec3(192,85,10);
    HIP[8] = vec3(42+168,90,10);
    KNEE[0] = vec3(29,118,7);
    KNEE[1] = vec3(48,120,8);
    KNEE[2] = vec3(97,117,10);
    KNEE[3] = vec3(130,107,10);
    KNEE[4] = vec3(144,120,7);
    KNEE[5] = vec3(167,118,7);
    KNEE[6] = vec3(167,118,7);
    KNEE[7] = vec3(181,111,7);
    KNEE[8] = vec3(168+29,118,7);
    ANKLE[0] = vec3(5,134,5);
    ANKLE[1] = vec3(22,132,6);
    ANKLE[2] = vec3(71,122,10);
    ANKLE[3] = vec3(113,127,10);
    ANKLE[4] = vec3(162,146,5);
    ANKLE[5] = vec3(164,146,5);
    ANKLE[6] = vec3(164,146,5);
    ANKLE[7] = vec3(168,137,5);
    ANKLE[8] = vec3(168+5,134,5);
    FOOT[0] = vec3(14,150,10);
    FOOT[1] = vec3(16,150,10);
    FOOT[2] = vec3(63,139,10);
    FOOT[3] = vec3(119,143,10);
    FOOT[4] = vec3(178,139,10);
    FOOT[5] = vec3(182,150,10);
    FOOT[6] = vec3(182,150,10);
    FOOT[7] = vec3(182,150,10);
    FOOT[8] = vec3(168+14,150,10);
}

vec3 shoulder1 = vec3(0.), elbow1 = vec3(0.), wrist1 = vec3(0.), head = vec3(0.),
     shoulder2 = vec3(0.), elbow2 = vec3(0.), wrist2 = vec3(0.);
vec3 foot1 = vec3(0.), ankle1 = vec3(0.), knee1 = vec3(0.), hip1 = vec3(0.),
     foot2 = vec3(0.), ankle2 = vec3(0.), knee2 = vec3(0.), hip2 = vec3(0.);

mat2 rot = mat2(0.), rot2 = mat2(0.);

vec3 get_arr(vec3 arr[9], int i)
{
    if (i == 0) return arr[0];
...
vec3 getPos(vec3 arr[9], int it, float kt, float z) {
    it = it - (8 * (it/8));
    vec3 p = mix(get_arr(arr, it), get_arr(arr, it+1), kt);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord )
{
    ...
    int it_mod_8 = it - (8 * (it/8));
    float dx = it_mod_8 < 4 ? -85.*.02 : +85.*.02; 
    foot2.x += dx;
    ankle2.x += dx;
    knee2.x += dx;
    hip2.x += dx;
