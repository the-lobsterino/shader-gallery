...
//
// power-2 mandelbrot, doubling the angles wrt to two directed lines through the origin per iteration.
// Both use the original sample position as the translation to complete the fold.
