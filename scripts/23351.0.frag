...
void main( void ) {
    ...
    if (length(position-mouse) < 0.05) {
        ...
        float rnd1 = mod(fract(sin(dot(position + time * 0.001, vec2(14.9898,78.233))) * 43758.5454), 1.0);
        ...
        //float count = (E.r*numstates + N.r*numstates + W.r*numstates + S.r*numstates + NE.r*numstates + NW.r*numstates + SE.r*numstates + SW.r*numstates);
