//---------------------------------------------------------
// Shader:   HexagonalGrid.glsl     by I.G.P   3/2015  
// sandbox:  glslsandbox.com/e#23499
// info:     draw hexagonal grid with variable grid size & thickness
//---------------------------------------------------------
#ifdef GL_ES
...
#define color1 vec3(0.2, 0.0, 0.2)  // grid color
#define color2 vec3(1.0, 1.0, 0.2)  // fill color
 
// return 0.0 .. 1.0 for hexagonal grid color
