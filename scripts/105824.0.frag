...
// What I want people to try and do with this shader:

// 1 - Try to raymarch a 3D shape using this shader.

// Post what you were able to do with this shader on this site, or shadertoy.com.
// When you post it, type this in the code (with the slashes):

// Attempted Improvement By [What your name is]. Requested by chaosrayne86.
...
vec3 doMagic(vec2 p)
{
    ...
    // normal
    //vec2 e = vec2( 2.0/resolution.x, 0.0 );
