/*
 * Original shader from: https://www.shadertoy.com/view/XdKyDm
 */
...
// Noise settings:
const float Power = .059;
const float MaxLength = 1.19904;
const float Dumping = 1.0;

#define PI 3.141592
#define HALF_PI 1.57079632679

const float DEG_TO_RAD = PI / 180.0;
const float TIME_FACTOR = .01;
...
float map(vec3 p) {
	...
	return sdBox(q, vec3(10.0, 2.0, 0.01));
}
