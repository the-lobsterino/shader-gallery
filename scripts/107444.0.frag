...
vec3 rainbow1(float h,float s,float b){
    return b*(1.0-s)+(b-b*(1.0-s))*clamp(abs(abs(6.0*(h-vec3(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999.5,1.485,0.625)/3.0))-3.0)-1.0,0.0,1.0);
}

vec3 colorFunc(float h) {

    return rainbow1( fract(h), 1.0, (0.5 + (sin(time)*2.5+0.5)));
