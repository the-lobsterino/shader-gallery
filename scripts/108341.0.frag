...
void main(void){
  ...
  const float maxd=99.0; //Max depth
  ...
  if (f<maxd){
    ...
    gl_FragColor=vec4((b*c+pow(b,9.0))*(1.0-f*.01),1.0);//simple phong LightPosition=CameraPosition
  }
