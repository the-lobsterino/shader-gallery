/*R050505作例　河内踊り　by ニシタマオ　THE SEA PANTHER*/
/*サンドボックス上での試験用、簡易レイトレシステム、反射・屈折、ぼかし影、カラーパレット機能付（R050503版）*/
/*直近の改修：前処理機能追加、過剰機能を削除、熊体機能改善、負荷軽減*/
...
vec4 VP_DefaultCamera =vec4(0, 4,-12, 0);
...
float fNLetters00(vec4 VP){
	float NP =1e+6;
		{ float nE =float(0.75);  vec3 V3C =vec3(2.5,2.5,1) *nE,  V3D =vec3(5,0,0) *nE, V3P;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(2,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(0,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(-2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(2,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-1) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(2,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-1) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-1) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0) *nE; VB.xy =vec2(2,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(0,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0) *nE; VB.xy =vec2(1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,2) *nE; VB.xy =vec2(2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,2) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(2,-2) *nE; VB.xy =vec2(-2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-2,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;}
...
float fNMuscle_Animal02(sskelton SS){	//軽量版
	vec4 VP =SS.VP, VA, VB;
	float NP =1e+6;
	VP.xyz *=fM3Rotate(SS.VR_Cntr.xyz);

	VA =SS.VP_Body, VB =SS.VP_Shld;
	NP =fNMin(NP, fNMusclePart02(VP, VA, VB));
	VA =SS.VP_Neck, VB =SS.VP_Head;
	NP =fNMin(NP, fNMusclePart02(VP, VA, VB));
	VA =SS.VP_ArRU, VB =SS.VP_ArRL;
	NP =fNMin(NP, fNMusclePart02(VP, VA, VB));
...
float fNOutfit_Dilbert01(sskelton SS){
	...
	if(true){
		...
		V3P.yz +=vec2(0.5,1) *nE;

		vec3 V3Pi;
		V3Pi =V3P;
		float nPi, nPj =1e+6;

		nPi =abs(V3Pi.z) -0.05 *nE;
		nPi =max(nPi, V3Pi.y -0.25);
		if(V3P.y >0.0)	nPj =min(nPj, nPi);	

		V3Pi =V3P;
		V3Pi.z +=0.4 *nE;
		nPi =abs(length(V3Pi.yz) -0.4 *nE) -0.05 *nE;
		if(V3Pi.z <0.0)	nPi =max(nPi, max(V3Pi.y +V3Pi.x,V3Pi.y -V3Pi.x));
		if(V3Pi.y <0.0)	nPj =min(nPj, nPi);

		nPj =max(nPj, abs(V3Pi.x) -0.2 *nE);
		NP =min(NP, nPj);
	}
...
ivec2 fIV2Hanoi34(int iSQ, int ID){
	ivec2 iV2P;

	{
		...
		if(ID ==1)	iV2P =ivec2(0,1);
		if(ID ==2)	iV2P =ivec2(0,2);
		if(ID ==3)	iV2P =ivec2(0,3);
	}
	if(iSQ ==1){
		if(ID ==0)	iV2P =ivec2(0,0);
		if(ID ==1)	iV2P =ivec2(0,1);
		if(ID ==2)	iV2P =ivec2(0,2);
		if(ID ==3)	iV2P =ivec2(1,0);
	}
	if(iSQ ==2){
		if(ID ==0)	iV2P =ivec2(0,0);
		if(ID ==1)	iV2P =ivec2(0,1);
		if(ID ==2)	iV2P =ivec2(2,0);
		if(ID ==3)	iV2P =ivec2(1,0);
	}
	if(iSQ ==3){
		if(ID ==0)	iV2P =ivec2(0,0);
	...
	if(iSQ ==5){
		...
		if(ID ==1)	iV2P =ivec2(1,0);
		if(ID ==2)	iV2P =ivec2(2,0);
		if(ID ==3)	iV2P =ivec2(0,1);
	}
	if(iSQ ==6){
		if(ID ==0)	iV2P =ivec2(0,0);
		if(ID ==1)	iV2P =ivec2(1,0);
		if(ID ==2)	iV2P =ivec2(1,1);
		if(ID ==3)	iV2P =ivec2(0,1);
	}
	if(iSQ ==7){
		if(ID ==0)	iV2P =ivec2(0,0);
	...
	if(iSQ ==15){
		...
		if(ID ==1)	iV2P =ivec2(2,1);
		if(ID ==2)	iV2P =ivec2(2,2);
		if(ID ==3)	iV2P =ivec2(2,3);
	}
	return iV2P;
}

vec3 fV3Morph(float nTime, vec3 V3From, vec3 V3To){
	float nMix =-cos(fract(nTime) *acos(-1.0)) *0.5 +0.5; 
	vec3 V3Now =mix(V3From, V3To, nMix);
	return V3Now;	
}

vec3 fV3Hanoi3(ivec2 iV2P, vec3 V3P0, vec3 V3P1, vec3 V3P2){
	vec3 V3P =V3P0, V3D =vec3(0,2,0);
	if(iV2P.x ==1) V3P =V3P1;
	if(iV2P.x ==2) V3P =V3P2;
	V3P +=V3D *float(iV2P.y);
	return V3P;
}

vec4 fVHanoi3Morph(vec4 VP, int ID, vec3 V3P0, vec3 V3P1, vec3 V3P2, vec3 V3R0, vec3 V3R1, vec3 V3R2){
	float nT0 =mod(VP.w,8.0), nT1 =mod(VP.w +1.0,8.0);
	int iSQ0 =int(nT0), iSQ1 =int(nT1);
	ivec2 iV2P0 =fIV2Hanoi33(iSQ0, ID), iV2P1 =fIV2Hanoi33(iSQ1, ID);
//	ivec2 iV2P0 =fIV2Hanoi34(iSQ0, ID), iV2P1 =fIV2Hanoi34(iSQ1, ID);
	vec3 V3P_From =fV3Hanoi3(iV2P0, V3P0, V3P1, V3P2), V3P_To =fV3Hanoi3(iV2P1, V3P0, V3P1, V3P2);

	vec3 V3R_From =V3R0;
	if(iV2P0.x ==1) V3R_From =V3R1;
	if(iV2P0.x ==2) V3R_From =V3R2;

	vec3 V3R_To =V3R0;
	if(iV2P0.x ==1) V3R_From =V3R1;
	if(iV2P0.x ==2) V3R_From =V3R2;

	VP.xyz -=fV3Morph(VP.w, V3P_From, V3P_To);
	VP.xyz *=fM3Rotate(fV3Morph(VP.w, V3R_From, V3R_To));

	if(true){
		vec3 V3D =vec3(0,ID +1,0) *sin(fract(VP.w) *acos(-1.0)) *1.0;
		VP.xyz -=V3D;
	}
	if(false){
		vec3 V3R =vec3(1) *cos(fract(VP.w) *acos(-1.0) *0.5 *float(ID)) *acos(-1.0);
		VP.xyz *=fM3Rotate(V3R);
	}

	return VP;
}

vec4 fVHanoi3Morph(vec4 VP, int ID, vec3 V3P0, vec3 V3P1, vec3 V3P2){
	return fVHanoi3Morph(VP, ID, V3P0, V3P1, V3P2, vec3(0), vec3(0), vec3(0));
}

//右足ホールド・左手アタッチの試験
sskelton fSSPSet_RandomMan01(sskelton SS){
	SS =fSSPSet_Man01(SS);
	float nT =SS.nMisc00, nA;
...
float fNObject_DanceDilbert01(vec4 VP){//踊り

	sskelton SS;
	SS.nMisc00 =floor(VP.w);
	sskelton SS0 =SS;
	SS0 =fSSRSet_Random01( SS0);
	SS0 =fSSPSet_RandomMan01( SS0);

	SS.nMisc00++;
	sskelton SS1 =SS;
	SS1 =fSSRSet_Random01( SS1);
	SS1 =fSSPSet_RandomMan01( SS1);

	SS =fSSChange_Inbetween(SS0, SS1, cos(fract(VP.w) *acos(-1.0)));
	SS.VR_FotR.a =SS.VR_FotL.a =0.0;
	SS =fSSkeltonMake( SS);

	SS.VP.xyz =VP.xyz +SS.VP_FotR.xyz;

	float NP =1e+6, nPi;
	nPi =fNMuscle_Man01(SS);
//	nPi =fNMuscle_Animal01(SS);
	NP =min(NP,nPi);
	nPi =fNOutfit_Dilbert01(SS);
//	nPi =fNOutfit_Bear01(SS);
	NP =min(NP,nPi);
	SS_Default =SS;
	return NP;
}
...
float fNMap(vec3 V3P){
	...
	if(true){	//ダンス
		...
		vec4 VPi =VP;
		vec2 V2P_Mod =mod(VPi.xz, vec2(24)) -vec2(12 +4,12), V2P_Dom =VPi.xz -V2P_Mod;
		...
		sface SFi;
		VPi.y -=1.0;
		nPi =fNObject_DanceDilbert01(VPi);
		...
		if(false){
			VPi.w +=10.7;
			VPi.xyz -=SS_Default.VP_HndL.xyz -SS_Default.VP_FotR.xyz;
			nPi =fNObject_DanceDilbert01(VPi);
			...
			SFi.ID_Pallet =52;
			SFi.VP =VPi;
			SFi.VMisc00.zx =V2P_Dom;
			SF =fSFMin(SF, SFi);
		}

		if(true){
			vec3 V3P0 =SS_Default.VP_HndR.xyz -SS_Default.VP_FotR.xyz +vec3(0,1,0);
			vec3 V3P1 =SS_Default.VP_Head.xyz -SS_Default.VP_FotR.xyz +vec3(0,2,0);
			vec3 V3P2 =SS_Default.VP_HndL.xyz -SS_Default.VP_FotR.xyz +vec3(0,1,0);
			vec3 V3R0 =SS_Default.VR_HndR.xyz;
			vec3 V3R1 =SS_Default.VR_Head.xyz;
			vec3 V3R2 =SS_Default.VR_HndL.xyz;

			for(int ID =0; ID <3; ID++){
				vec4 VPi =fVHanoi3Morph(VPi, ID, V3P0, V3P1, V3P2); //, V3R0, V3R1, V3R2);
				float nPi =max(length(VPi.xz) -2.0 +float(ID) *0.5, abs(VPi.y) -1.0);
				SFi =fSFSet_Default(nPi);
				SFi.ID_Object =11;
				SFi.ID_Pallet =52;
				SFi.VP =VPi;
...
sface fSFEffect_Before(sface SF, smarch SM){
	...
	if(SF.ID_Pallet ==52){
		float nRandom =fNRandom(SF.VMisc00.xz);
		VColor.rgb =sin((vec3(0,1,2) /3.0 +nRandom) *acos(-1.0) *2.0) *0.2 +0.8;
	}
