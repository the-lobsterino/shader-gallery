// chatGPT , give me a woman in a bikini
// chatGPT , you bitch, add blood
// chatGPT , make the woman less sexy
// chatGPT , add some scrolling lines behind the woman
// chatGPT , change the colors 
// chatGPT , woman needs some dick
//chatGPT  , give  woman  arms
//chatGPT  , make the woman more sexy
...
{
	/* shift butt belly */
	float dx = .10 * exp(-pow((p.z-.8),2.)/.6) - .18 * exp(-pow((p.z -.1),2.)/.4);
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    float val = sin(iTime+p1.x+p1.y*1000.0)*(0.8+sin(p1.y*p1.x*2.5+iTime*3.0)*0.3);
