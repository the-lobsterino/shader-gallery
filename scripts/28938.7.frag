...
#define TH atan(surfacePosition.x+50.0, surfacePosition.y+5.0)
#define time time + sin(R+TH*93328.0-time)/R*0.5
...
void main( void ) {
   ...
   vec3 a1=grad(a/328.0);
   
   gl_FragColor = vec4(a1.x,a1.y,a1.z,0.0);
}