...
d += H(r()); add(); d += E(r()); add(); d += L(r()); add();d += L(r()); add();d += O(r()); add();  space(); d += V(r()); add();d += I(r()); add();d += O(r()); add(); d +=L(r()); add();d += E(r()); add();d+=T(r());
newline();
d += I(r()); space(); add();d += A(r()); add();d += M(r()); add(); space(); d += L(r()); add();d += I(r()); add();d += M(r()); add(); d +=E(r()); add(); d +=EX(r());
newline();
;
newline();
