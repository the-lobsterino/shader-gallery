// N110920N awesome this shader with some lines of code such impression!
// N130920N Mandelset Room
//
//
// you can have this shader in a windows exe with sound as an so called "Scene Demo"
//
//
// skype: alien 5ive
//
...
float de(vec3 pos) {
	...
	for (int i=0; i<Iterations; i++) {
		...
		z = vec2(z.x * z.x - z.y * z.y, 2.0 * z.x * z.y) - z*cos(time)+c*sin(time);
		float r2 = length(z); // dot(z, c);
