...
#define TEXT _F _u _c _k _M _e _exc
...
#define _lpa col+=char(vec2(401542.45,66572.0),uv)*text_color;
...
float sprite(vec2 spr, vec2 size, vec2 uv)
{
	...
	return bounds ? extract_bit(spr.x, bit - 35.0) + extract_bit(spr.y, bit) : 0.0;
}
