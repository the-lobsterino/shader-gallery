...
{
	float c = 0.;
	if (y == 0.0) c = (x < 8.0 ? 592.0 : 0.0); if (y == 1.0) c = (x < 8.0 ? 2388.0 : 0.0);
	...
	float s = SELECT(x,c);
	if (s == 0.) gl_FragColor = RGB(252.,216.,168.);
	if (s == 1.) gl_FragColor = RGB(192.,56.,0.);
	if (s == 2.) gl_FragColor = RGB(0.,0.,0.);
}
...
void spr_tree(float x, float y)
{
	...
	float s = SELECT(x,c);
	if (s == 0.) gl_FragColor = RGB(252.,216.,168.);
	if (s == 1.) gl_FragColor = RGB(0.,156.,0.);
	if (s == 2.) gl_FragColor = RGB(0.,0.,0.);
}
...
void spr_player_down(float f, float x, float y)
{
	...
	if (f == 0.) {
		...
		float s = SELECT(x,c);
		if (s == 1.) gl_FragColor = RGB(128.,208.,16.);
		if (s == 2.) gl_FragColor = RGB(255.,160.,68.);
		if (s == 3.) gl_FragColor = RGB(228.,92.,16.);
	}
	if (f == 1.) {
		if (y == 0.) c = (x < 8. ? 21504. : 21.); if (y == 1.) c = (x < 8. ? 21760. : 85.);
		if (y == 2.) c = (x < 8. ? 64800. : 2175.); if (y == 3.) c = (x < 8. ? 65312. : 2303.);
	...
	if (f == 2.) {
		...
		float s = SELECT(x,c);
		if (s == 1.) gl_FragColor = RGB(228.,92.,16.);
		if (s == 2.) gl_FragColor = RGB(128.,208.,16.);
		if (s == 3.) gl_FragColor = RGB(255.,160.,68.);
	}
}
...
void spr_player_left(float f, float x, float y)
{
	...
	float s = SELECT(x,c);
	if (s == 1.) gl_FragColor = RGB(128.,208.,16.);
	if (s == 2.) gl_FragColor = RGB(228.,92.,16.);
	if (s == 3.) gl_FragColor = RGB(255.,160.,68.);
}
...
void spr_enemy(float f, float tDirX, float tDirY, float x, float y)
{
	...
	if (f == 0.) {
		...
		float s = SELECT(x,c);
		if (s == 1.) gl_FragColor = RGB(224.,80.,0.);
		if (s == 2.) gl_FragColor = RGB(255.,255.,255.);
		if (s == 3.) gl_FragColor = RGB(255.,160.,0.);
	}
	if (f == 1.) {
	...
	if (f == 2. || f == 5. || f == 7.) {		
		...
		if (s == 1.) gl_FragColor = RGB(255.,255.,255.);
		if (s == 2.) gl_FragColor = RGB(104.,136.,255.);
	}
	if (f == 3. || f == 6.) {
	...
	if ((tileX >= -4. && tileX <= 2. && tileY >= -2. && tileY <= 0.) ||
	   ...
	   ((tileX >= -6. && tileX <= 4.) || (tileY >= -4. && tileY <= 2.)))) {
			...
			if (mod(pixelX * 5.5 + pixelY * 4.,21.) == 0.)
				gl_FragColor = mix(RGB(252.,206.,168.),RGB(252.,196.,118.),length(p / 256.));
			else
				gl_FragColor = RGB(252.,216.,168.);
	} else {
...
void main(void)
{
	...
	vec2 uv = floor((gl_FragCoord.xy - iResolution.xy / 2.0) / size);
