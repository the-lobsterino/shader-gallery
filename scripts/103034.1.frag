/*R050501作例　鉄棒　by ニシタマオ　THE SEA PANTHER*/
...
float fNLetters00(vec4 VP){
	float NP =1e+6;
		{ float nE =float(1);  vec3 V3C =vec3(2.5,2.5,1) *nE,  V3D =vec3(5,0,0) *nE, V3P;V3P.x -=V3C.x; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,0.5) *nE; VB.xy =vec2(-1,2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,2) *nE; VB.xy =vec2(-0.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,0.5) *nE; VB.xy =vec2(-0.5,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1,0.5) *nE; VB.xy =vec2(-1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-2,-2) *nE; VB.xy =vec2(-0.5,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-0.5) *nE; VB.xy =vec2(-0.5,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,-1) *nE; VB.xy =vec2(-1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-0.5,-1) *nE; VB.xy =vec2(-1,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,2) *nE; VB.xy =vec2(-0.5,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1) *nE; VB.xy =vec2(2,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0) *nE; VB.xy =vec2(2,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2) *nE; VB.xy =vec2(1,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-0.5) *nE; VB.xy =vec2(0,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-0.5) *nE; VB.xy =vec2(2,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D; {   vec4 VP_Keep =VP;   VP.xyz -=V3P;{ float nE =nE;  vec4 VA, VB; VA.w =float(1) *nE;{ VA.xy =vec2(-2,1) *nE; VB.xy =vec2(-1,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,2) *nE; VB.xy =vec2(-1.5,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,1) *nE; VB.xy =vec2(-2,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(-1.5,0.5) *nE; VB.xy =vec2(-1,0) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,1.5) *nE; VB.xy =vec2(2,1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,1) *nE; VB.xy =vec2(1.5,1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,0.5) *nE; VB.xy =vec2(2,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,2) *nE; VB.xy =vec2(1,0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(0,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(0,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,0.5) *nE; VB.xy =vec2(2,-0.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0.5,-1) *nE; VB.xy =vec2(1.5,-1) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(0,-1.5) *nE; VB.xy =vec2(2,-1.5) *nE; NP =min(NP, fNLL(VP, VA, VB));}{ VA.xy =vec2(1,-0.5) *nE; VB.xy =vec2(1,-2) *nE; NP =min(NP, fNLL(VP, VA, VB));}}   VP =VP_Keep; }V3P +=V3D;}
...
//
sskelton fSSRSet_CrowBar01P(sskelton SS){
	float nD =acos(-1.0) /180.0, nS =sin(SS.VP.w);
	SS.VR_Body =vec4(0,	+30,	+30,	0);
	SS.VR_Shld =vec4(0,	0, 	0,	1);
	SS.VR_Neck =vec4(0,	0,	+45,	0);
	SS.VR_Head =vec4(0,	0,	0,	1);
	SS.VR_ArRU =vec4(180,	0,	0,	0);
	SS.VR_ArLU =vec4(-30,	0,	0,	0);
	SS.VR_ArRL =vec4(0,	0,	0,	1);
	SS.VR_ArLL =vec4(0,	0,	0,	1);
	SS.VR_LeRU =vec4(+15,	0,	0,	0);
	SS.VR_LeLU =vec4(-15,	0,	0,	0);
...
sskelton fSSRSet_CrowBar01N(sskelton SS){
	float nD =acos(-1.0) /180.0, nS =sin(SS.VP.w);
	SS.VR_Body =vec4(-45,	0,	0,	0);
	SS.VR_Shld =vec4(0,	0, 	0,	1);
	SS.VR_Neck =vec4(0,	0,	0,	0);
	SS.VR_Head =vec4(0,	0,	0,	1);
	SS.VR_ArRU =vec4(-15,	0,	+45,	0);
	SS.VR_ArLU =vec4(-15,	0,	-45,	0);
	SS.VR_ArRL =vec4(0,	0,	-90,	1);
	SS.VR_ArLL =vec4(0,	0,	+90,	1);
	SS.VR_LeRU =vec4(+45,	0,	+45,	0);
	SS.VR_LeLU =vec4(+45,	0,	-45,	0);
...
float fNObject_CrowBarDilbert01(vec4 VP){//鉄棒
	VP.w *=0.25;

	VP.yz *=fM2Rotate(sin(-VP.w *acos(-1.0) *2.0) *acos(-1.0));

	sskelton SS,SSP,SSN;
	SS.VP =VP;
	SS =SSP =SSN =fSSPSet_Man01( SS);
	SSP =fSSRSet_CrowBar01P( SS);
	SSN =fSSRSet_CrowBar01N( SS);
...
float fNMap(vec3 V3P){
	...
	if(true){	//鉄棒
		...
		vec4 VPi =VP;
		vec2 V2P_Mod =mod(VPi.xz, vec2(12,16)) -vec2(6,8), V2P_Dom =VPi.xz -V2P_Mod;
		VPi.w +=V2P_Dom.x *10.3;
		...
		nPi =fNObject_CrowBarDilbert01(VPi);

		SFi =fSFSet_Default(nPi);
		SFi.ID_Object =11;
		SFi.ID_Pallet =52;
		SFi.VP =VPi;
		SFi.VMisc00.x =V2P_Dom.x;
		SF =fSFMin(SF, SFi);
	}
...
sface fSFEffect_Before(sface SF, smarch SM){
	...
	if(SF.ID_Pallet ==51){
		VColor.rgb =sign(sin(VP.x *2.0)) *vec3(1,1,0) *0.5 +vec3(1,1,0) *0.5;
	}
