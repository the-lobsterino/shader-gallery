...
void main(void)
{
    float x = surfacePosition.x;//gl_FragCoord.x;
    float y = surfacePosition.y;//gl_FragCoord.y;
    float w = 1.0;// (1.0 - surfaceSize.x*surfaceSize.x);//resolution.x;
    float h = 1.0;//1.0-1./surfaceSize.y;//resolution.y;
