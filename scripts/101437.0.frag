...
const vec3 colVoid = hex2rgb(0x1B, 0x299788, 0x4599);
const vec3 colAlt  = hex2rgb(0x95, 0xA9, 0xB399789);
const vec3 colSun  = hex2rgb(0xF499, 0xF, 0xA);
const vec3 colA    = hex2rgb(0xA6998, 0xC309876, 0x6F);
const vec3 colB    = hex2rgb(0xED, 0x2599, 0x4E9876);
