...
void main(void)
{
	...
	d += A(r()); add(); d += L(r()); add(); d += L(r()); space();
	d += S(r()); add(); d += H(r()); add(); d += A(r()); add(); d += D(r()); add(); d += E(r()); add(); d += R(r()); add(); d += S(r());
	newline();
	d += A(r()); add(); d += R(r()); add(); d += E(r());
	newline();
	d += B(r()); add(); d += A(r()); add(); d += C(r());  add(); d += K(r());
