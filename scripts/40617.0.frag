...
vec3 Text(vec2 uv)
{
    	...
    	vec2 center_pos = vec2(res.x/5.0 - STRWIDTH(20.0)/2.0,res.y/1.5 - STRHEIGHT(1.0)/2.0);
       	
    	BEGIN_TEXT(center_pos.x,center_pos.y)
	HEX(0xABCDEF) _les HEX(0xFF0000) _i _T _a _y _s _o _n HEX(0x00FF00) _L _a _b HEX(0xABCDEF) _grt HEX(0x00FFFF) _ _P _r _e _s _e _n _t _s HEX(0xFFFFFF)_ _A _n _o _t _h _e _r _ _P _l _a _n _e _t _nl
        _a _ _g _a _m _e _ _m _a _d _e _ _f _u _l _l _y _ _w _i _t _h _ _G _L _S _L _les _p _r _e _s _s _ _a _n _y _ _k _e _y _grt
