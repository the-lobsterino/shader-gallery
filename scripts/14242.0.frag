...
void main( void ) {
	...
	color += thing(p, vec2(sin(time6 * 99.0 + 0.25), cos(time6 * 99.0 + 09.25)) * 0.5, vec3(6.5, .5, 1.0), 0.01);
	...
	color += thing(p, vec2(sin(time3 * 99.0 + 1.0), cos(time3 * 99.0+ 16.0)) * 0.8, vec3(6.5, 6.5, 6.0), 0.01);
