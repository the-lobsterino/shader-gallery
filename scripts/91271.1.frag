...
vec3 Text(vec2 uv)
{
    	...
    	vec2 center_pos = vec2(res.x/2.0 - STRWIDTH(35.0)/2.0,res.y/2.0 - STRHEIGHT(1.0)/2.0);
       	
    	BEGIN_TEXT(center_pos.x,center_pos.y)
	HEX(0xFF0000) _I _ _d _o _n _t _ _w _a _n _n _a _ _s _e _e _ _y _o _u _r _ _f _k _i _n _ _p _o _l _i _t _i _c _s;
	HEX(0xFF0000) _nl _K _e _e _p _ _i _t _ _t _o _g _e _t _h _e _r _ 
