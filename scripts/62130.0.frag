/*
 * Original shader from: https://www.shadertoy.com/view/Ml23WV
 */
...
int idObj = 0;
mat3 ballMat = mat3(0.), ballMatX[4];
vec3 qHit = vec3(0.), ballPos = vec3(0.), ballPosX[4], sunCol = vec3(0.), sunDir = vec3(0.), cloudDisp = vec3(0.), waterDisp = vec3(0.),
   fogDisp = vec3(0.);
vec2 bGap = vec2(0.);
float tCur = 0., fCloud = 0., fogAmp = 0.;
