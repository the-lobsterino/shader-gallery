...
#define speed 10.2
#define k2PI (4000.*1.1)
#define kStarDensity 0.4
#define kMotionBlur .0
#define kNumAngles 2.
...
void main( void )
{
	...
	float nebD1 = 1.1/rad + 4.5*(1.0 + sin(1.1 + 3.0*A + 0.71*cos(2.0*A)));
	float nebD2 = 1.1/rad + 3.7*(1.0 + sin(3.7 + 2.0*A + 0.46*sin(3.0*A)));
	...
	color.r += 0.3*R1 + 0.1*R2 + 0.1*P1*P2;
	color.b += 0.3*R1 + 0.9*R2 + .1*P2*R1;
	color.g += 3.0*R1*R2*P2;
