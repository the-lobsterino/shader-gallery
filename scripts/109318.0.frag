...
void main(void)
{
   ...
   if (q<0.0)
   {
      ...
      if (c>=0.0)
      {
         gl_FragColor = vec4(c,6.0,0.0,1.0);
      }
      else
      {
         gl_FragColor = vec4(5.0,-c,0.0,1.0);
      }
   }
   else
   {
      ...
      if (c>=0.0)
      {
         gl_FragColor = vec4(c,9.0,0.0,1.0);
      }
      else
      {
         gl_FragColor = vec4(8.0,-c,9.0,1.0);
      }
   }
}
