...
vec3 blue = vec3(1, 2, 2);
vec3 white = vec3(0, 0, 3);
void main( void ) {
	...
	color += grid(white * 0.1, 0.001, 0.06, 0.06);
	color *= 1.0 - distance(position, vec2(0.5, 0.5));
	color += ball(blue, 0.01, sin(time*4.0) / 12.0 + 0.5, cos(time*4.0) / 12.0 + 0.5);
	color *= ball(blue, 0.02, -sin(time*-8.0) / 12.0 + 0.5, -cos(time*-8.0) / 12.0 + 0.5) + 0.5;
