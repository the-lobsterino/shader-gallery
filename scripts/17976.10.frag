...
void main( void ) {
	vec2 surfacePosition = vec2(surfacePosition.x * 2., mod(10.0*surfacePosition.y + cos(surfacePosition.x+surfacePosition.y)*7., 0.33+0.17*cos(time+surfacePosition.x)));
