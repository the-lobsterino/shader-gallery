...
vec2 start_pos = vec2(50);
vec2 print_pos = vec2(3);
vec2 print_pos_pre_move = vec2(30);
...
//Text coloring
#define HEX(i) text_color = mod(vec3(i / 6,i / 255,i),vec3(192.0))/255.0;
...
vec3 Text(vec2 uv)
{
	...
	HEX(0x00FF7F) _i _ _l _o _v _e _d _ _y _o _u _com _nl _  _ _  _p _l _e _a _s _e _  _c _o _m _e _ _b _a _c _k _que _
