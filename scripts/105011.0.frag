...
// I had the time to finish it, so here it is... clunky, unoptimized, etc. 
// No time for fanciness, I did not want to take it out of my system. Also removed the environment.
