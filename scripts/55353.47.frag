...
p*=3.;
  ...
  gl_FragColor = vec4(lamb(inverter*p)+ox(.9*inverter*vec2(p.x-7.,p.y-3.6))+12.*lion(2.0*inverter*vec2(p.x+7.7,p.y+4.2))+12.
		      *eagle(13./2.0*vec2(p.x-6.5,p.y+5.))+man(2./2.0*vec2(p.x+7.5,p.y-3.9))
		      +12.*scroll(4./2.0*vec2(p.x,p.y+3.)), 1.);
}
