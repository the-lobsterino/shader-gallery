/*
 * Original shader from: https://www.shadertoy.com/view/4dtSDs
 */
...
vec3 fishP = vec3(0.), qHit = vec3(0.), sunDir = vec3(0.), waterDisp = vec3(0.);
float dstFar = 0., tCur = 0., bowlRad = 0., bowlHt = 0., fishLen = 0., angTail = 0., angFin = 0., posMth = 0.;
bool inBowl = false, chkBowl = false;
int idObj = 0;
