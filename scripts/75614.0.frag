const bool donuts = true;                                                   precision highp float;
                                                  ...
                                                  ,0.,0.)),c=d(a-vec3(.01,0.,0.)),e=d(a+vec3(0.,.1,0.)),f=d(a-vec3(0.,.11,
                                                  0.)),g=d(a+vec3(0.,0.,.01)),h=d(a-vec3(0.,0.,.01));return normalize(vec3(
                                                 b-c,e-f,g-h));}float l(vec3 c,               vec3 e){float a=1.,b=1e+4;for(
                                               ...
                                               .xy)/resolution.y; vec3 a =                         vec3(1.,1.,4.),i=vec3(0.0),
                                               b=normalize(i-a),m=vec3(1.,                         1.,0.),e=normalize(cross(b,
