...
vec3 Text(vec2 uv)
{
	...
	RGB(1,0,0) _P RGB(1,.5,0)_E RGB(1,1,0)_N RGB(0,1,0)_I RGB(0,.5,1)_S RGB(0.5,0,1)_ _ RGB(1,0,0)_B RGB(1,.5,0)_a RGB(1,1,0)_l RGB(0,1,0)_l
