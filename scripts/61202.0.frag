/*
 * Original shader from: https://www.shadertoy.com/view/4t23Ww
 */
...
//camera
vec3  cp = vec3(0.); //camera position
mat3  cr = mat3(0.); //camera rotation

//coloring
float ff = 0.; //fog falloff

//ifs
float fu = 0.; //fractal_spheresubstract
float fd = 0.; //fractal_distancemult
vec3 cs = vec3(0.);  //fractal_csize
float fs = 0.; //fractal_size
vec3 fc = vec3(0.);  //fractal_c
