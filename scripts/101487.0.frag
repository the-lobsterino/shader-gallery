/*
 * Original shader from: https://www.shadertoy.com/view/tsySDw
 */
...
{ 
  ...
  else
  {
      ...
      else
      {
        ...
        if(shadowCast <= (d - (lightInfo.w + 1.41)))
          intensity *= 0.5;
...
{  
  ...
  vec3 lookAt =  cameraPos + vec3(10.0, cos(time)*1.0, sin(time*0.25)*14.5);
