...
void main( void ) {
	...
	float rho = position.x*position.x+position.y*position.y;
	position.x = (rho+time*0.001)*sin(phi*6.00+cos(time*0.01));
	position.y = (rho+time*0.001)*cos(phi*6.00+cos(time*0.01));
