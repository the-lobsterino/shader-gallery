// N090920N Fractal surface life form
...
float mandelbrot(vec2 c)
{
	...
	{		
		z = vec2(z.x * z.x - z.y * z.y, 2.0 * z.x * z.y) - render_text(sin(0.1*time)*z); // z*cos(t)+c*sin(t);
