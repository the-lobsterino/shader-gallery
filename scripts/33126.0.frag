...
vec3 processColor(vec3 p)
{
	...
	if (ground<d) { col = vec3(diff+spec*0.3)*vec3(0.6,0.3,0.0); d = ground; }
	if (letters<d) { col = vec3(p.y*0.01+0.0,0.1,p.y+.3)+diff+spec; }
...
{	
	...
	letters = min(letters,B(p.xy-vec2(-1.00,0.9))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,R(p.xy-vec2(-0.50,0.9))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,N(p.xy-vec2( 0.00,0.9))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,A(p.xy-vec2( 0.50,0.9))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,R(p.xy-vec2( 1.00,0.9))+cos(time*5.1-1.0)*0.03);
	letters = min(letters,D(p.xy-vec2( 1.50,0.9))+cos(time*5.1-2.0)*0.03);
	
	letters = min(letters,R(p.xy-vec2(-1.00,0.2))+cos(time*5.1+3.0)*0.03);
	letters = min(letters,I(p.xy-vec2(-0.50,0.2))+cos(time*5.1+2.0)*0.03);
	letters = min(letters,S(p.xy-vec2( 0.00,0.2))+cos(time*5.1+1.0)*0.03);
	letters = min(letters,I(p.xy-vec2( 0.50,0.2))+cos(time*5.1+0.0)*0.03);
	letters = min(letters,N(p.xy-vec2( 1.00,0.2))+cos(time*5.1-1.0)*0.03);
	letters = min(letters,G(p.xy-vec2( 1.50,0.2))+cos(time*5.1-2.0)*0.03);
