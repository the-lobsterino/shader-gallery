...
{	
	...
	{		
		color = vec3(1.0, 0.82, 0.14)*sin(1.3+(length(position.xy-vec2(-10400.0,72.0))/8.0));
	...
	else
	{
		...
		float pos = position.y * (86.0/53.0);
				...
				if(abs(position.x) < 105.0 && position.y > 0.0 && position.y <60.0) color = vec3(0.2, 0.2, 0.2);
		if(abs(position.x) < 105.0 && position.y > -19.0 && position.y <18.0) color = vec3(0.0, 0.0, 1.0);
		else if(abs(position.x) < 105.0 && position.y < 0.0 && position.y> -60.0) color = vec3(1.0, .1, 0.0);
