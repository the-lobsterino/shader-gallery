...
#define CHAR_SIZE vec2(6.0, 7.5)
#define CHAR_SPACING vec2(6.0, 12.0)
#define DOWN_SCALE 1.0
vec2 scale = vec2 (3.50, 10.0);
...
vec3 Text(vec2 uv)
{
	...
	print_pos = vec2(mod(time * -100.0, res.x * 5.000) -400.0,25.0 );
	_d _r _f _g _g  _w _a _s _  _a _spc  _m _i _s _t _a _k _e _exc 
