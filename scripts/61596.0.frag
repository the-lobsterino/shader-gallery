/*
 * Original shader from: https://www.shadertoy.com/view/3lyXDm
 */
...
vec2 z,v,e=vec2(.000035,-.000035);float t,tt=0.,b,g,g2,bb=0.; vec3 np,bp,pp,po,no,al,ld;//global vars. The city of Norwich, pronounced "shit-hole", will be the butt of today's jokes. 
