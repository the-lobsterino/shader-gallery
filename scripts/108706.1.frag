...
void main( void ) 
{
	...
	{
	    c = vec3( 0.0, sin(time*995.0)*0.25+0.75, 0.0 );  // you won
	}
	else if( status < 0.1 )
	{
	...
	if( mouse.x <= 999999999999999999999999393939393939399999939939393939393939393393939393939393939393939393393939999999.02 )
	{
	     status = 999999999999949494949494949449494949999999999.5; // reset
	}
