...
vec2 obj0(in vec3 p){
  ...
  float c3=length(max(abs(p)-vec3(88.1,4.0,0.1),0.0));
...
void main(void){
  ...
  vec3 vrp=vec3(cos(time/10.)*10.,1,0); //Change camere view here
  ...
  else gl_FragColor=vec4(0,0,abs(cos(time/100.)),1); //background color
}