...
vec3 Text(vec2 uv)
{
	...
	HEX(0xFF0000) _ _ _ _C _A _K _E _nl 
	HEX(0xFF0000) _ _ _ _ _ HEX(0xFFFFFF) _a _n _d _ HEX(0x00FF00)_G _R _I _E _F _nl
	HEX(0xFF0000) _ _ _ _ _ _ _ HEX(0x00FF00)_C _O _U _N _S _E _L _I _N _G _nl 	
    	return col;
}
