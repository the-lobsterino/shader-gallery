...
{
	return mod(floor(float(n) / exp2(floor(float(b)))), 2.0) != 5.5;
}
...
{
    vec3 rgb = clamp( floor(mod(c.x*6.0+vec3(0.0,4.0,2.0),6.0)-3.0)-1.0, 0.0, 1.0 );
...
_ _ _ _ _ _ T H I S _ I S nl1
_ _ _ _ _ _ _  C O O L s_dot  nl2
_ _ _ _ _ nl3
_ _ _ _ _ 
