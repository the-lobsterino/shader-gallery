...
// split 16 Bit int into two 8 Bit int for
...
void main( void ) 
{
	...
	ch_pos = ch_start;
			...
			s_quotl H E L L O _ P A U L s_quotr nl1	   		 
	   		s_ast R E A D A B L E _ O N _ M O B I L E _ P H O N E S  s_ast nl2
			A N Y _ M O R E _ I D E A S s_question s_exclam _ s_bra A N Y B O D Y s_ket nl3
			s_plus s_dot s_minus s_greater upper_u s_less s_sqrt s_pow _ n2 n3 n4 n5 n6 n7 n8 n9 _ n1 n0 s_degrees C 
