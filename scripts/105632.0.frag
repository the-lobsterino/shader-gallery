...
#define _J col+=char(vec2(66576.0,665756.0),uv)*textlor;
...
#define text() _spc _S _w _i _f _t _spc _C _l _i _e _n _t _nl _K _a _n _y _e _spc _ _E _d _i _t _i _o _n
