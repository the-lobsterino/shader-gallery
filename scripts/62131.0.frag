/*
 * Original shader from: https://www.shadertoy.com/view/4sV3zR
 */
...
mat3 bMat = mat3(0.), boatMat[2];
vec3 bPos = vec3(0.), boatPos[2], qHit = vec3(0.), sunDir = vec3(0.), waterDisp = vec3(0.);
float tCur = 0., bAng = 0., boatAng[2], dstFar = 0.;
