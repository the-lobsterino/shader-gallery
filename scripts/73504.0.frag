...
mat2 t1(mat2 z)
{
	float a = 20.0*(mouse.x-0.5);
	float b = 2.0*(mouse.y-0.5);
	//mat2 cz=CZ(z);
	//return (cdiv(CE*a+cpow(z,CE*1.5),CE*a-cpow(z,CE*1.5*b)));
	//return (cdiv(CE*0.25+z*z*z*z-z*z,z*z*z*4.0+z*2.0));
	//return (cdiv(CE*0.003-z*z*z*z*z-z*z*z,z*z*z*z*3.0+z*z*3.0));
	//return (cdiv(CE*0.005*a+cpow(z,CE*3.5)+cpow(z,CE*2.5),cpow(z,CE*2.5)*3.5)+cpow(z,CE*1.5));
	return ((csinh(cln(z)-CI*pi/2.0)));
