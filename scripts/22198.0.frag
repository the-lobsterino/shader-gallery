...
//Although their accomplishments were few the real pride of the institute was the well lit ample parking.
...
void main() {
	...
	if(tim>1.0)ta=vec3(0.0,0.0,-20.0);
	...
	gl_FragColor = vec4(col*dimmer*dimmer,1.0);
}
